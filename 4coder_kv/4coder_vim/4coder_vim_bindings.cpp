...
function b32
vim_map_set_binding(u32 mode, u32 sub_mode, void *func, u64 key)
{
...
myinline b32
VimBind(u32 mode, Custom_Command_Function *custom, Vim_Sub_Mode sub_mode, u64 key)
{
 return vim_map_set_binding(mode, sub_mode, (void *)custom, key);
}
myinline b32
VimBind(u32 mode, Custom_Command_Function_2 *custom, u64 key)
{
 return vim_map_set_binding(mode, SUB_None, (void *)custom, key);
}
myinline b32
VimBind(u32 mode, Custom_Command_Function *custom, u64 key)
{
    return vim_map_set_binding(mode, SUB_None, (void *)custom, key);
}
