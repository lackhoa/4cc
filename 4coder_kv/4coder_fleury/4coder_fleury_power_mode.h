...
internal Vec2_f32 F4_PowerMode_CameraOffsetFromView(App *app, View_ID view);
internal void F4_PowerMode_Spawn(App *app, View_ID view, u8 character);
internal void F4_PowerMode_Tick(App *app, Frame_Info frame_info);
internal void F4_PowerMode_RenderBuffer(App *app, View_ID view, Face_ID face, Frame_Info frame_info);
internal void F4_PowerMode_RenderWholeScreen(App *app, Frame_Info frame_info);
