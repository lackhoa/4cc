...
TokenCppKind_NotAlt = 93,
TokenCppKind_AndAlt = 94,
TokenCppKind_OrAlt = 95,
TokenCppKind_Auto = 96,
TokenCppKind_Void = 97,
TokenCppKind_Bool = 98,
TokenCppKind_Char = 99,
TokenCppKind_Int = 100,
TokenCppKind_Float = 101,
TokenCppKind_Double = 102,
TokenCppKind_Long = 103,
TokenCppKind_Short = 104,
TokenCppKind_Unsigned = 105,
TokenCppKind_Signed = 106,
TokenCppKind_Const = 107,
TokenCppKind_Volatile = 108,
TokenCppKind_Asm = 109,
TokenCppKind_Break = 110,
TokenCppKind_Case = 111,
TokenCppKind_Catch = 112,
TokenCppKind_Continue = 113,
TokenCppKind_Default = 114,
TokenCppKind_Do = 115,
TokenCppKind_Else = 116,
TokenCppKind_For = 117,
TokenCppKind_Goto = 118,
TokenCppKind_If = 119,
TokenCppKind_Return = 120,
TokenCppKind_Switch = 121,
TokenCppKind_Try = 122,
TokenCppKind_While = 123,
TokenCppKind_StaticAssert = 124,
TokenCppKind_ConstCast = 125,
TokenCppKind_DynamicCast = 126,
TokenCppKind_ReinterpretCast = 127,
TokenCppKind_StaticCast = 128,
TokenCppKind_Class = 129,
TokenCppKind_Enum = 130,
TokenCppKind_Struct = 131,
TokenCppKind_Typedef = 132,
TokenCppKind_Union = 133,
TokenCppKind_Template = 134,
TokenCppKind_Typename = 135,
TokenCppKind_Friend = 136,
TokenCppKind_Namespace = 137,
TokenCppKind_Private = 138,
TokenCppKind_Protected = 139,
TokenCppKind_Public = 140,
TokenCppKind_Using = 141,
TokenCppKind_Extern = 142,
TokenCppKind_Export = 143,
TokenCppKind_Inline = 144,
TokenCppKind_Static = 145,
TokenCppKind_Virtual = 146,
TokenCppKind_AlignAs = 147,
TokenCppKind_Explicit = 148,
TokenCppKind_NoExcept = 149,
TokenCppKind_NullPtr = 150,
TokenCppKind_Operator = 151,
TokenCppKind_Register = 152,
TokenCppKind_This = 153,
TokenCppKind_ThreadLocal = 154,
TokenCppKind_SizeOf = 155,
TokenCppKind_AlignOf = 156,
TokenCppKind_DeclType = 157,
TokenCppKind_TypeID = 158,
TokenCppKind_New = 159,
TokenCppKind_Delete = 160,
