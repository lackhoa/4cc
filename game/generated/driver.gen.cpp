...
draw(bez_line(thumb_kbot, thumb_triangle_tip), lp(I4(2, 4, 0, 3)));
vv(thumb_kmid_in, (V3(0.4589f, -2.9094f, -0.2208f)));
draw(bez_unit(thumb_kmid_in, V2(0.f, 2.9015f), V2(0, 0), V3y(1), from_parent()*thumb_palm_conn));
vv(thumb_ktop_in, (V3(0.565f, -3.0125f, -0.2208f)), 1);
draw(thumb_kmid_in, thumb_ktop_in, lp(I4(8, 4, 3, 1)));
vv(thumb_tip, (V3(0.671f, -3.0515f, -0.2208f)));
vv(thumb_kmid_out, (V3(0.5068f, -2.8209f, -0.2208f)));
draw(bez_unit(thumb_triangle_tip, V2(-0.2102f, 0.1944f), V2(0.4217f, 0.2078f), V3x(-1), thumb_kmid_out), lp(I4(2, 4, 4, 6)));
vv(thumb_ktop_out, (V3(0.6128f, -2.9593f, -0.2208f)), 1);
draw(bez_unit(thumb_kmid_out, V2(0.f, 0.3706f), V2(0, 0), V3x(-1), thumb_ktop_out));
draw(bez_unit(thumb_ktop_out, V2(0.f, 0.2369f), V2(0.4569f, -1.7741f), V3x(-1), thumb_tip), lp(I4(4, 1, 2, 1)));
draw(bez_unit(thumb_ktop_in, V2(0, 0), V2(0.2207f, 1.4562f), V3x(-1), thumb_tip), lp(I4(1, 1, 1, 2)));
}
draw(thumb_palm_conn, kline_out, lp(I4(5, 3, 1, 1)));
if(level1){
draw(knuckle_line);
}
draw(bez_v3v2(forearm.radius_bump, (V3(-0.f, 0.0101f, 0.0167f)), V2(0, 0), thumb_kbot));
{
...
draw(bez_unit(forearm.middle_finger_meeter, V2(-0.1285f, 0.1793f), V2(0.f, -0.5674f), V3z(-1), middle_palm_bot));
}
...
draw(bez_unit(finger_bases[ifinger], V2(0.f, 0.5811f), knuckle_control, V3x(-1), okmid), lp(I4(3, 1, 1, 1)));
draw(bez_unit(finger_bases[ifinger+1], V2(-0.3782f, 0.3545f), knuckle_control, V3x(1), ikmid), lp(I4(3, 3, 3, 1)));
if(ifinger == 0){
draw(bez_v3v2(kline_out, (V3(0.0001f, 0.f, 0.f)), V2(0, 0), finger_bases[0]), lp(I4(0, 1, 1, 3)));
}
if(ifinger == finger_count-1){
draw(bez_v3v2(finger_bases[ifinger+1], (V3(-0.0049f, 0.f, 0.f)), V2(0, 0), kline_in), lp(I4(2, 3, 0, 1)));
}
}
{
...
draw(bez_unit(ikmid, control, V2(), V3x(1), iktop), lp(I4(3, 3, 3, 1)));
draw(bez_unit(okmid, control, V2(), V3x(-1), oktop), lp(I4(3, 0, 2, 3)));
}
v3 tip = k+vec;
{
...
draw(bez_unit(tip, tip_control, knuckle_control, V3x(-1), iktop), lp(I4(3, 0, 0, 2)));
draw(bez_unit(tip, tip_control, knuckle_control, V3x(1), oktop), lp(I4(4, 0, 2, 3)));
}
}
}
}}
...
Bez delt_hline = bez_unit2(delt_top, (V4(-0.059f, 0.584f, 0.f, 0.f)), (V3(0.f, 1.f, 0.f)), delt_top_back+(V3()));
...
{
draw(bezd_len(delt_back, V3(-0.f, 0.f, -0.0662f), V2(0, 0), tricep_mid), I4(5, 0, 0, 0));
...
draw(bez_v3v2(torso.scap_sock_bot, (V3(-0.2354f, 0.048f, 0.f)), V2(0.2603f, -0.0407f), white_in), lp(I4(0, 0, 8, 0)));
}
{
...
if(ok){
draw(bez_v3v2(bicep_side_top2, (V3(0.0184f, 0.f, 0.0925f)), V2(0, 0), brachio_a), lp(radii));
}
}
}
}
...
Bez tricep_cross_line = bez_v3v2(tricep_wedge, (V3(0.0474f, -0.0292f, 0.0884f)), V2(0, 0), elbow_up_out);
...
bs_v3v2(v676, V3(-0.f, 0.1052f, -0.0852f), V2(0.f, 0.0936f), v677);
}
{
...
bb_v3v2(l493, in_a, V3(-0.0385f, 0.f, 0.f), V2(0, 0), in_b, lp(I4(0, 2, 2, 5)));
...
v3 &a = arm.brachio_a;
va(brachio_b, a+(V3(0.1483f, -0.2286f, -0.0134f)));
va(brachio_c, (V3(0.2034f, -1.85f, 0.1108f)));
v3 b = brachio_b;
v3 c = brachio_c;
draw(bez_v3v2(b, (V3(0.0352f, 0.f, -0.f)), V2(0, 0), c), lp(I4(6, 5, 3, 1)));
...
draw(bez_unit(arm.brachio_humerus, V2(0.f, 0.0875f), V2(0, 0), V3z(1), arm.brachio_a));
draw(bez_unit(arm.brachio_humerus2, V2(0.f, 0.0875f), V2(0.f, 0.1935f), V3(0.7928f, 0.f, 0.6095f), brachio_b), I4(0, 0, 3, 6));
...
draw(bez_v3v2(ulnar_ball, (V3(0.0482f, 0.f, -0.f)), V2(0, 0), v566), lp(I4(0, 5, 2, 0)));
draw(bez_v3v2(arm.function_condyle, (V3(-0.0671f, 0.f, 0.f)), V2(0, 0), v566), lp(I4(1, 5, 5, 0)));
draw_line(radius_back, radius_bump);
fill3(radius_back, v593, lerp(radius_bump, 0.1308f, near_palm_in));
}
vv(middle_finger_meeter, (V3(0.0936f, -2.5386f, -0.171f)));
v3 v2189 = (V3(-0.2725f, -0.8924f, -0.251f));
draw(bez_v3v2(v2189, (V3(0.f, 0.1288f, 0.1481f)), V2(0, 0), (V3(0.1923f, -1.8531f, -0.198f))));
...
draw(bez_offset(shoulder_in, V3(0.0993f, -0.0342f, -0.f), V3(-0.0356f, 0.0675f, -0.0634f), shoulder), I4(5, 3, 3, 1));
{
if(level1){
push_hl();
}
...
if(is_left()){
draw(bez_bezd_old(sternum, V3(0.f, 0.0027f, 0.2265f), V2(0.f, 0.0935f), rib_mid));
}
vv(ribL, rib_mid+(V3(0.559f, -0.7158f, -0.2772f)));
v3 rib_in = rib_mid+V3x((0.0905f));
draw(bez_unit2(rib_in, V4(0.f, 0.0689f, 0.0558f, 0.2431f), V3(0.629f, -0.2482f, 0.7367f), ribL), I4(2, 6, 3, 1));
fill4(rib_mid, ribL, delt_collar, sternum);
va(rib_back, ribL+(V3(0.0855f, 0.171f, -0.5742f)));
draw(bez_unit(ribL, V2(-0.0705f, 0.2667f), V2(0.f, 0.384f), V3(0.5421f, -0.8353f, 0.0916f), rib_back));
{
vv(vestL, ribL+(V3(0.0371f, 0.3022f, 0.0011f)));
draw(bez_unit2(rib_in, V4(0.f, 0.4043f, 0.f, 0.2469f), (V3(0.f, 0.852f, 0.5235f)), vestL));
vv(vest_back, rib_back+(V3(-0.f, 0.5114f, -0.0067f)));
draw(bez_unit2(vestL, V4(-0.0067f, 0.1427f, 0.f, 0.3102f), V3(0.9212f, -0.3891f, -0.f), vest_back));
}
}
...
if(level2){
hl_block;
draw(bez_unit2(scap_delt, V4(0.f, 0.1307f, 0.f, 0.0566f), V3(0.5328f, 0.0057f, -0.8462f), shoulder));
}
...
draw(bez_v3v3(trap_bot, V3(0.235f, 0.3261f, -0.0079f), V3(0.0805f, 0.f, 0.0552f), back_archL));
{
hl_block;
b32 disabled = is_right();
set_in_block(painter.painting_disabled, disabled);
vv(scap_bot, scap_delt+V3(0.1134f, -0.7434f, 0.1812f));
va(scap_sock_bot, scap_sock_top+V3(0.0098f, -0.2771f, 0.f));
bs_unit2(scap_delt, V4(-0.14f, 0.1607f, 0.4409f, 0.224f), V3(-0.6328f, 0.f, -0.7743f), scap_bot);
bs_unit2(scap_delt, V4(0, 0, 0, 0), V3(), scap_sock_top);
bs_unit2(scap_bot, V4(0.f, 0.118f, 0.f, 0.f), V3(-0.f, 0.f, -1.f), scap_sock_bot);
...
draw(bez_unit2(chest_in, V4(-0.0299f, 0.2108f, 0.1371f, 0.253f), V3(0.0915f, -0.523f, 0.8474f), chest_out), I4(6, 4, 3, 1));
...
bs_unit(crotchL, V2(-0.2081f, 0.2062f), V2(0.316f, 0.3309f), bikini_dir, bikiniL);
bs_unit(crotchL, V2(-0.2767f, 0.2024f), V2(0.213f, 0.2503f), -bikini_dir, bikiniL);
}
v3 bikini_up_back;
{
...
bb_unit2(girdle_side_line, girdle_front, V4(-0.3554f, 0.3781f, 0.2608f, 0.2404f), V3(0.7543f, 0.6022f, 0.2614f), bikini_up_back, I4(0, 6, 6, 1));
bs_bezd_old(bikini_front_mid, V3(-0.0581f, -0.1036f, 0.f), V2(-0.0136f, 0.1226f), girdle_front);
{
...
fill3(nose_rootL, eye_in, es_up_in, fp(eye_in_shade));
...
bb_bezd_old(eye_low_line, eye_in, V3(0.1735f, -0.2094f, 0.1663f), V2(0.117f, 0.2053f), eye_out, eye_low_line_radii);
{
...
{
bb_raw(eye_up_line_now, eye_in, lerp(eye_up_line[1], tblink, eye_low_line[1]), lerp(eye_up_line[2], tblink, eye_low_line[2]), eye_out, eye_up_line_radii);
...
va(nose_rootL, V3(nose_sideX, lerp(browY, (0.1534f), noseY), faceZ+(-0.104f)));
...
{
v3 lip_in = sety(philtrum_lowL+(V3(-0.f, 0.f, -0.0527f)), mouth_corner.y+(0.0133f));
Bezier lip_up_bot = bez_unit2(lip_in, (V4(-0.0828f, 0.5237f, 0.f, 0.f)), (V3(0.f, 0.2748f, 0.9615f)), mouth_corner);
draw(lip_up_bot, (V4( 0.4876f, 0.3631f, 0.5066f, -0.2905f)));
}
{
...
bb_unit2(nose_line_side, nose_rootL, V4(), V3(0.f, 0.f, 1.f), v1219, lp_invisible());
vv(nose_tipL, nose_tip+V3x(nose_sideX));
bs_offset(nose_tipL, V3(0.0121f, -0.0404f, -0.1108f), V3(), nose_wing, V4(0.151758f, 0.699609f, 1.149659f, -0.148325f));
{
symx_off;
...
{
bs_parabola(nose_wing, V3(0.0539f, 0.07f, -0.0417f), nose_wing_up, profile_visible_transition(0.70f));
}
{
symx_off;
v3 control = V3(-0.0533f, 0.0283f, 0.0438f);
draw(bez_offset(nose_tipL, control, negateX(control), negateX(nose_tipL)), 0.7097f*painter.line_params.radii);
}
...
bb_unit(ear1, ear_center, V2(0.2792f, 3.5588f), V2(0.1526f, 0.3068f), V3(0.3587f, 0.692f, -0.6264f), ear_back, lp(radii1));
...
draw(get_uline(head_back, 0.5f), lp((0.9797f), I4(1, 3, 3, 0)));
}
...
v3 control_point = V3(0.f, (-chin_point0.y + 4*mouth_low_valley.y)/3.f, (-chin_point0.z + 4*mouth_low_valley.z)/3.f);
...
vv(a1626, V3(0.2651f, -0.5154f, 0.8715f));
vv(b1627, V3(0.5636f, -0.3601f, 0.5385f));
draw(bez_unit2(a1626, V4(0.f, 0.1801f, 0.0364f, 0.3141f), V3(0.866f, 0.f, 0.5f), b1627), small_to_big());
vv(c1633, V3(0.5266f, -0.6385f, 0.68f));
draw(bez_unit2(b1627, V4(), V3(), c1633), big_to_small());
}
b32 hair_on = fbool(1);
{
set_in_block(painter.painting_disabled, not hair_on or painter.painting_disabled);
...
for_i32(yi, yi_min, yi_max)
     {
v1 y = unit*v1(yi);
draw_line(V3(x, y, (-1.8208f)), V3(x, y, (1.7172f)));
}
}
}
{
...
Torso torso_obj;
{
set_in_block(painter.painting_disabled, !show_body || painter.painting_disabled);
...
draw_image(filename, center, V3z(width), V3y(1.f), (0.5f));
}
if(camera_is_front()){
const i32 start = 4;
...
draw_image(filename, center, V3x(-width), V3y(1.f), fval(0.3033f));
}else if(preset == 4){
...
mat4i forearmT = trs_pivot_transform(translate, rotate, 1.f, forearm_rotation_pivot);
