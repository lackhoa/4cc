...
function void
send_bez_v3v2(String name, String p0, v3 d0, v2 d3, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
...
send_bez_parabola(String name, String p0, v3 d, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_offset(String name, String p0, v3 d0, v3 d3, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_unit(String name, String p0, v2 d0, v2 d3, v3 unit_y, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_unit2(String name, String p0, v4 d0d3, v3 unit_y, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_c2(String name, String ref, v3 d3, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
...
send_bez_line(String name, String p0, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_bezd_old(String name, String p0, v3 d0, v2 d3, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
...
send_bez_negateX(String name, String ref, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Curve_Index ref_index = get_curve_by_name(m, ref).index;
kv_assert(ref_index.v);
Curve_Union data = {.negateX={ .ref=ref_index, }};
send_bez_func(name, Curve_Type_NegateX, data, params, linum);
}function void
send_bez_lerp(String name, String begin, String end, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
...
send_bez_raw(String name, String p0, v3 p1, v3 p2, String p3, Line_Params params, i32 linum){Modeler &m = *painter.modeler;
Vertex_Index p0_index = get_vertex_by_name(m, p0).index;
kv_assert(p0_index.v);
Vertex_Index p3_index = get_vertex_by_name(m, p3).index;
kv_assert(p3_index.v);
