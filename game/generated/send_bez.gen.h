//NOTE Generated at C:\Users\vodan\4ed\code/meta_main.cpp:195:
//  C:\Users\vodan\4ed\code/meta_main.cpp:197:
...
}return {};}//  C:\Users\vodan\4ed\code/meta_main.cpp:228:
//  C:\Users\vodan\4ed\code/meta_main.cpp:241:
function void
send_bez_v3v2(String name, String p0, v3 d0, v2 d3, String p3, Line_Params params=lp(), i32 linum=__builtin_LINE());
inline void
send_bez_v3v2(String name, String p0, v3 d0, v2 d3, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_v3v2(name, p0, d0, d3, p3, lp(radii), linum);
}inline void
send_bez_v3v2(String name, String p0, v3 d0, v2 d3, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_v3v2(name, p0, d0, d3, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_parabola(String name, String p0, v3 d, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_parabola(name, p0, d, p3, lp(radii), linum);
}inline void
send_bez_parabola(String name, String p0, v3 d, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_parabola(name, p0, d, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_offset(String name, String p0, v3 d0, v3 d3, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_offset(name, p0, d0, d3, p3, lp(radii), linum);
}inline void
send_bez_offset(String name, String p0, v3 d0, v3 d3, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_offset(name, p0, d0, d3, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_unit(String name, String p0, v2 d0, v2 d3, v3 unit_y, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_unit(name, p0, d0, d3, unit_y, p3, lp(radii), linum);
}inline void
send_bez_unit(String name, String p0, v2 d0, v2 d3, v3 unit_y, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_unit(name, p0, d0, d3, unit_y, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_unit2(String name, String p0, v4 d0d3, v3 unit_y, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_unit2(name, p0, d0d3, unit_y, p3, lp(radii), linum);
}inline void
send_bez_unit2(String name, String p0, v4 d0d3, v3 unit_y, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_unit2(name, p0, d0d3, unit_y, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_c2(String name, String ref, v3 d3, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_c2(name, ref, d3, p3, lp(radii), linum);
}inline void
send_bez_c2(String name, String ref, v3 d3, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_c2(name, ref, d3, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_line(String name, String p0, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_line(name, p0, p3, lp(radii), linum);
}inline void
send_bez_line(String name, String p0, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_line(name, p0, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_bezd_old(String name, String p0, v3 d0, v2 d3, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_bezd_old(name, p0, d0, d3, p3, lp(radii), linum);
}inline void
send_bez_bezd_old(String name, String p0, v3 d0, v2 d3, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_bezd_old(name, p0, d0, d3, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_negateX(String name, String ref, i4 radii, i32 linum=__builtin_LINE()){send_bez_negateX(name, ref, lp(radii), linum);
}inline void
send_bez_negateX(String name, String ref, v4 radii, i32 linum=__builtin_LINE()){send_bez_negateX(name, ref, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_lerp(String name, String begin, String end, i4 radii, i32 linum=__builtin_LINE()){send_bez_lerp(name, begin, end, lp(radii), linum);
}inline void
send_bez_lerp(String name, String begin, String end, v4 radii, i32 linum=__builtin_LINE()){send_bez_lerp(name, begin, end, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
...
inline void
send_bez_raw(String name, String p0, v3 p1, v3 p2, String p3, i4 radii, i32 linum=__builtin_LINE()){send_bez_raw(name, p0, p1, p2, p3, lp(radii), linum);
}inline void
send_bez_raw(String name, String p0, v3 p1, v3 p2, String p3, v4 radii, i32 linum=__builtin_LINE()){send_bez_raw(name, p0, p1, p2, p3, lp(radii), linum);
}//  C:\Users\vodan\4ed\code/meta_main.cpp:278:
