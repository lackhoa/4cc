...
function Type_Info
get_type_info_argb();//  C:\Users\vodan\4ed\code\meta_print.cpp:444:
function Type_Info
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:457:
function void
read_binary_argb(Data_Reader &r, argb *dst);
//  C:\Users\vodan\4ed\code\meta_print.cpp:462:
function void
read_binary_argb(Data_Reader &r, argb *dst){read_binary_u32(r, dst);};
typedef i1 b32;
//  C:\Users\vodan\4ed\code\meta_print.cpp:440:
function Type_Info
get_type_info_b32();//  C:\Users\vodan\4ed\code\meta_print.cpp:444:
function Type_Info
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:457:
function void
read_binary_b32(Data_Reader &r, b32 *dst);
//  C:\Users\vodan\4ed\code\meta_print.cpp:462:
function void
read_binary_b32(Data_Reader &r, b32 *dst){read_binary_i1(r, dst);};
struct Vertex_Index{
i1 v;
};
...
function void
read_binary_Vertex_Index(Data_Reader &r, Vertex_Index *dst){
i1 m_v = {};
{
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Curve_Index(Data_Reader &r, Curve_Index *dst){
i1 m_v = {};
{
read_binary_i1(r, &m_v);
}
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Fill_Index(Data_Reader &r, Fill_Index *dst){
i1 m_v = {};
{
read_binary_i1(r, &m_v);
}
...
Bone_Thumb = 10,
Bone_Pelvis = 11,
Bone_Eyeball = 12,};//  C:\Users\vodan\4ed\code\meta_print.cpp:385:
function Type_Info
get_type_info_Bone_Type();//  C:\Users\vodan\4ed\code\meta_print.cpp:389:
function Type_Info
...
function void
read_binary_Bone_Type(Data_Reader &r, Bone_Type *dst);
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Bone_ID(Data_Reader &r, Bone_ID *dst){
Bone_Type m_type = {};
{
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:440:
function Type_Info
get_type_info_Line_Flags();//  C:\Users\vodan\4ed\code\meta_print.cpp:444:
function Type_Info
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:457:
function void
read_binary_Line_Flags(Data_Reader &r, Line_Flags *dst);
//  C:\Users\vodan\4ed\code\meta_print.cpp:462:
function void
read_binary_Line_Flags(Data_Reader &r, Line_Flags *dst){read_binary_u32(r, dst);};
//  C:\Users\vodan\4ed\code\meta_print.cpp:370:
enum {Line_Overlay = 1,
Line_Straight = 2,
Line_No_SymX = 4,};;
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Common_Line_Params(Data_Reader &r, Common_Line_Params *dst){
v1 m_radius_mult = {};
{
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:440:
function Type_Info
get_type_info_Poly_Flags();//  C:\Users\vodan\4ed\code\meta_print.cpp:444:
function Type_Info
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:457:
function void
read_binary_Poly_Flags(Data_Reader &r, Poly_Flags *dst);
//  C:\Users\vodan\4ed\code\meta_print.cpp:462:
function void
read_binary_Poly_Flags(Data_Reader &r, Poly_Flags *dst){read_binary_u32(r, dst);};
struct Fill_Params{
argb color;
Poly_Flags flags;
};
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Fill_Params(Data_Reader &r, Fill_Params *dst){
argb m_color = {};
{
read_binary_argb(r, &m_color);
}
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Line_Params(Data_Reader &r, Line_Params *dst){
v4 m_radii = {};
{
read_binary_v4(r, &m_radii);
}
...
//  C:\Users\vodan\4ed\code\meta_print.cpp:236:
function void
read_binary_Common_Line_Params_Index(Data_Reader &r, Common_Line_Params_Index *dst){
i1 m_v = {};
{
read_binary_i1(r, &m_v);
}
