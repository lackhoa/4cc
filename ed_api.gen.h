...
#define ed_draw_set_clip_sig() Rect_f32 ed_draw_set_clip(App* app, Rect_f32 new_clip)
#define ed_text_layout_get_visible_range_sig() Range_i64 ed_text_layout_get_visible_range(App* app, Text_Layout_ID text_layout_id)
#define ed_text_layout_character_on_screen_sig() Rect_f32 ed_text_layout_character_on_screen(App* app, Text_Layout_ID layout_id, i64 pos)
...
#define ed_target_last_config_sig() Render_Config* ed_target_last_config(Render_Target* target)
#define ed_draw_new_group_sig() Render_Config* ed_draw_new_group(Render_Target* target)
#define ed_draw_rect_outline_sig() void ed_draw_rect_outline(App* app, rect2 rect, v1 roundness, v1 thickness, ARGB_Color color, v1 depth)
#define ed_target_set_clip_sig() rect2 ed_target_set_clip(Render_Target* target, rect2 clip_box)
...
#define log_string_spam__params String string
...
#define target_last_config__return Render_Config*
#define target_last_config__params Render_Target* target
...
#define target_set_clip__return rect2
#define target_set_clip__params Render_Target* target, rect2 clip_box
#define im_begin__return b32
#define im_begin__params char* name, b32* p_open, ImGuiWindowFlags flags
#define im_end__return void
...
wrap_function_pointer(seek_pos);
...
wrap_function_pointer(target_last_config);
wrap_function_pointer(draw_new_group);
wrap_function_pointer(draw_rect_outline);
wrap_function_pointer(target_set_clip);
...
function Render_Config* target_last_config(Render_Target* target);
...
function rect2 target_set_clip(Render_Target* target, rect2 clip_box);
...
STORAGE_CLASS wrap_function_pointer(seek_pos);
...
STORAGE_CLASS wrap_function_pointer(target_last_config);
STORAGE_CLASS wrap_function_pointer(draw_new_group);
STORAGE_CLASS wrap_function_pointer(draw_rect_outline);
STORAGE_CLASS wrap_function_pointer(target_set_clip);
