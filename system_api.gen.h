...
#define system_get_clipboard_sig() String system_get_clipboard(Arena* arena, i32 index)
#define system_post_clipboard_sig() void system_post_clipboard(String str, i32 index)
...
#define system_condition_variable_wait_sig() void system_condition_variable_wait(System_Condition_Variable cv, System_Mutex mutex, i32 timeout_ms)
...
#define system_running__return b32
...
#define system_get_clipboard__params Arena* arena, i32 index
#define system_post_clipboard__return void
#define system_post_clipboard__params String str, i32 index
...
#define system_thread_get_id__return i32
...
#define system_condition_variable_wait__params System_Condition_Variable cv, System_Mutex mutex, i32 timeout_ms
...
#define system_show_mouse_cursor__params i32 show
...
function String system_get_clipboard(Arena* arena, i32 index);
function void system_post_clipboard(String str, i32 index);
...
function i32 system_thread_get_id(void);
...
function void system_condition_variable_wait(System_Condition_Variable cv, System_Mutex mutex, i32 timeout_ms);
...
function void system_show_mouse_cursor(i32 show);
