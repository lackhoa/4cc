...
doc_custom_api__global(Arena *arena, API_Definition *api_def, Doc_Cluster *cluster){
    ...
    if (begin_doc_call(arena, cluster, api_def, "clipboard_post_function_only", &func)){
        doc_function_brief(arena, &func, "Post a string to 4coder's function list clipboard history; the string is not posted to the system's clipboard with this call");
