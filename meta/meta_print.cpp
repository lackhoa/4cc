...
{// NOTE(kv) Doesn't really have to return Meta_Printer,
 ...
 if(file)
 {
  ...
  // NOTE(kv) File only, no line: the line number shifted every .gen file's header on
  // any edit to the metaprogram (pointless diff churn, 2026-09-12).
  p<"// NOTE Generated by "<call_file<"\n";
