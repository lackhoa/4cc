...
#define custom_alloc_buffer_positions_on_buffer_sig() Managed_Object custom_alloc_buffer_positions_on_buffer(App* app, Buffer_ID buffer_id, i32 count, Managed_Scope* optional_extra_scope)
...
#define alloc_buffer_positions_on_buffer__return Managed_Object
#define alloc_buffer_positions_on_buffer__params App* app, Buffer_ID buffer_id, i32 count, Managed_Scope* optional_extra_scope
...
#define text_layout_get_visible_range__return Range_i64
#define text_layout_get_visible_range__params App* app, Text_Layout_ID text_layout_id
...
wrap_function_pointer(alloc_buffer_positions_on_buffer);
...
wrap_function_pointer(text_layout_get_visible_range);
...
function Managed_Object alloc_buffer_positions_on_buffer(App* app, Buffer_ID buffer_id, i32 count, Managed_Scope* optional_extra_scope);
...
function Range_i64 text_layout_get_visible_range(App* app, Text_Layout_ID text_layout_id);
...
STORAGE_CLASS wrap_function_pointer(alloc_buffer_positions_on_buffer);
...
STORAGE_CLASS wrap_function_pointer(text_layout_get_visible_range);
