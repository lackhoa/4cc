...
function BOOL
GetFileAttributesEx_utf8String(Arena *scratch, String file_name, GET_FILEEX_INFO_LEVELS info_level_id, LPVOID file_info);

function HMODULE
LoadLibrary_utf8String(Arena *scratch, String file_name);
