...
function F4_Index_File *F4_Index_LookupFile(App *app, Buffer_ID buffer);
function F4_Index_File *F4_Index_LookupOrMakeFile(App *app, Buffer_ID buffer);
function void F4_Index_EraseFile(App *app, Buffer_ID id);
function void F4_Index_ClearFile(F4_Index_File *file);
function F4_Index_Note *F4_Index_LookupNote(String string, F4_Index_Note *parent);
function F4_Index_Note *F4_Index_LookupNote(String string);
...
function void F4_Index_ParseFile(App *app, F4_Index_File *file, String string, Token_Array tokens);
function b32 F4_Index_ParseCtx_Inc(F4_Index_ParseCtx *ctx, F4_Index_TokenSkipFlags flags);
function b32 F4_Index_RequireToken(F4_Index_ParseCtx *ctx, String string, F4_Index_TokenSkipFlags flags);
...
function b32 F4_Index_PeekToken(F4_Index_ParseCtx *ctx, String string);
...
function String F4_Index_StringFromRange(F4_Index_ParseCtx *ctx, Range_i64 range);
function String F4_Index_StringFromToken(F4_Index_ParseCtx *ctx, Token *token);
...
function void F4_Index_Tick(App *app);
