...
api(system) function String get_clipboard(Arena* arena, i32 index);
api(system) function void post_clipboard(String str, i32 index);
...
api(system) function void condition_variable_wait(System_Condition_Variable cv, System_Mutex mutex, i32 timeout_ms);
