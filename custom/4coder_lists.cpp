...
struct File_Name_Result{
    ...
    b32 clicked;
    b32 is_folder;
    String_Const_u8 filename_activated;
    String_Const_u8 filename_in_text_field;
...
activate_open_or_new__generic(Application_Links *app, View_ID view,
                              String_Const_u8 path, String_Const_u8 filename, b32 is_folder,
...
CUSTOM_DOC("Interactively open a file out of the file system.")
{
    for (;;){
        ...
        String_Const_u8 full_filename = push_stringf(scratch, "%.*s/%.*s",
...
CUSTOM_DOC("Interactively creates a new file.")
{
    for (;;){
        ...
        String_Const_u8 filename = result.filename_in_text_field;
