...
{ PROC_LINKS(c, 0), false, "c", 1, "change to compilation buffer", 28, "C:\\Users\\vodan/4ed/code/4coder_kv/4coder_kv_commands.cpp", 56, 783 },
...
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 2105 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1411 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1583 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1569 },
...
{ PROC_LINKS(init, 0), false, "init", 4, "configure your editor!", 22, "C:\\Users\\vodan/4ed/code/4coder_kv/4coder_kv_commands.cpp", 56, 810 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1364 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1766 },
...
{ PROC_LINKS(kv_miscellaneous_debug_command, 0), false, "kv_miscellaneous_debug_command", 30, "just a placeholder command so I can test stuff", 46, "C:\\Users\\vodan/4ed/code/4coder_kv/4coder_kv_commands.cpp", 56, 801 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1523 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1563 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1557 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1604 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 2099 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file.", 92, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1687 },
{ PROC_LINKS(open_matching_file_cpp_other_panel, 0), false, "open_matching_file_cpp_other_panel", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1699 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1310 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1331 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1347 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1746 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1926 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 2023 },
...
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1488 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1784 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1219 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1210 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1201 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1142 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1154 },
...
{ PROC_LINKS(s, 0), false, "s", 1, "change to search buffer", 23, "C:\\Users\\vodan/4ed/code/4coder_kv/4coder_kv_commands.cpp", 56, 789 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1774 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1455 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1136 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1148 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1724 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1874 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "C:\\Users\\vodan/4ed/code/custom/4coder_base_commands.cpp", 55, 1952 },
