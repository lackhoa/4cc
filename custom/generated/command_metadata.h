...
{ PROC_LINKS(allow_mouse, 0), false, "allow_mouse", 11, "Shows the mouse and causes all mouse input to be processed normally.", 68, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 573 },
...
{ PROC_LINKS(change_active_primary_panel_backwards, 0), false, "change_active_primary_panel_backwards", 37, "Change the currently active panel, moving to the panel with the next lowest view_id.", 84, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 454 },
...
{ PROC_LINKS(clear_all_themes, 0), false, "clear_all_themes", 16, "Clear the theme list", 20, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 657 },
...
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2366 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2374 },
...
{ PROC_LINKS(init, 0), false, "init", 4, "configure your editor!", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 806 },
...
{ PROC_LINKS(kv_miscellaneous_debug_command, 0), false, "kv_miscellaneous_debug_command", 30, "just a placeholder command so I can test stuff", 46, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 797 },
...
{ PROC_LINKS(load_themes_default_folder, 0), false, "load_themes_default_folder", 26, "Loads all the theme files in the default theme folder.", 54, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 627 },
{ PROC_LINKS(load_themes_hot_directory, 0), false, "load_themes_hot_directory", 25, "Loads all the theme files in the current hot directory.", 55, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 646 },
...
{ PROC_LINKS(open_panel_hsplit, 0), false, "open_panel_hsplit", 17, "Create a new panel by horizontally splitting the active panel.", 62, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 474 },
{ PROC_LINKS(open_panel_vsplit, 0), false, "open_panel_vsplit", 17, "Create a new panel by vertically splitting the active panel.", 60, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 464 },
...
{ PROC_LINKS(save_all_dirty_buffers, 0), false, "save_all_dirty_buffers", 22, "Saves all buffers marked dirty (showing the '*' indicator).", 59, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 546 },
...
{ PROC_LINKS(seek_beginning_of_line, 0), false, "seek_beginning_of_line", 22, "Seeks the cursor to the beginning of the visual line.", 53, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2354 },
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2342 },
{ PROC_LINKS(seek_end_of_line, 0), false, "seek_end_of_line", 16, "Seeks the cursor to the end of the visual line.", 47, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2360 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2348 },
...
{ PROC_LINKS(set_mode_to_notepad_like, 0), false, "set_mode_to_notepad_like", 24, "Sets the edit mode to Notepad like.", 35, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 591 },
{ PROC_LINKS(set_mode_to_original, 0), false, "set_mode_to_original", 20, "Sets the edit mode to 4coder original.", 38, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 585 },
...
{ PROC_LINKS(suppress_mouse, 0), false, "suppress_mouse", 14, "Hides the mouse and causes all mosue input (clicks, position, wheel) to be ignored.", 83, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 567 },
...
{ PROC_LINKS(toggle_fullscreen, 0), false, "toggle_fullscreen", 17, "Toggle fullscreen mode on or off.  The change(s) do not take effect until the next frame.", 89, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 621 },
{ PROC_LINKS(toggle_highlight_enclosing_scopes, 0), false, "toggle_highlight_enclosing_scopes", 33, "In code files scopes surrounding the cursor are highlighted with distinguishing colors.", 87, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 605 },
{ PROC_LINKS(toggle_highlight_line_at_cursor, 0), false, "toggle_highlight_line_at_cursor", 31, "Toggles the line highlight at the cursor.", 41, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 597 },
...
{ PROC_LINKS(toggle_mouse, 0), false, "toggle_mouse", 12, "Toggles the mouse suppression mode, see suppress_mouse and allow_mouse.", 71, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 579 },
{ PROC_LINKS(toggle_paren_matching_helper, 0), false, "toggle_paren_matching_helper", 28, "In code files matching parentheses pairs are colored with distinguishing colors.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 613 },
...
static i32 fcoder_metacmd_ID_jump_to_definition = 73;
static i32 fcoder_metacmd_ID_jump_to_definition_at_cursor = 74;
static i32 fcoder_metacmd_ID_jump_to_last_point = 75;
...
static i32 fcoder_metacmd_ID_kv_miscellaneous_debug_command = 80;
static i32 fcoder_metacmd_ID_kv_open_note_file = 81;
static i32 fcoder_metacmd_ID_kv_profile_disable_and_inspect = 82;
static i32 fcoder_metacmd_ID_kv_reopen_with_confirmation = 83;
static i32 fcoder_metacmd_ID_kv_run = 84;
...
static i32 fcoder_metacmd_ID_load_project_current_dir = 101;
...
static i32 fcoder_metacmd_ID_no_op = 144;
static i32 fcoder_metacmd_ID_open_all_code = 145;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 146;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 147;
static i32 fcoder_metacmd_ID_open_in_other = 148;
static i32 fcoder_metacmd_ID_open_long_braces = 149;
static i32 fcoder_metacmd_ID_open_long_braces_break = 150;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 151;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 152;
static i32 fcoder_metacmd_ID_open_matching_file_cpp_other_panel = 153;
...
static i32 fcoder_metacmd_ID_reg = 194;
static i32 fcoder_metacmd_ID_rename_file_query = 195;
static i32 fcoder_metacmd_ID_reopen = 196;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 197;
static i32 fcoder_metacmd_ID_replace_in_buffer = 198;
static i32 fcoder_metacmd_ID_replace_in_range = 199;
static i32 fcoder_metacmd_ID_reverse_search = 200;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 201;
static i32 fcoder_metacmd_ID_right_adjust_view = 202;
...
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 213;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 214;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 215;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 216;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 217;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 218;
