...
{ PROC_LINKS(debug_camera_on, 0), false, "debug_camera_on", 15, "", 0, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4ed_kv_game_.cpp", 50, 82 },
...
{ PROC_LINKS(dir, 0), false, "dir", 3, "kv copy dir name", 16, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 853 },
...
{ PROC_LINKS(file, 0), false, "file", 4, "kv copy file name", 17, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 847 },
...
{ PROC_LINKS(game_disable, 0), false, "game_disable", 12, "", 0, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4ed_kv_game_.cpp", 50, 74 },
{ PROC_LINKS(game_enable, 0), false, "game_enable", 11, "", 0, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4ed_kv_game_.cpp", 50, 68 },
...
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2362 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2370 },
...
{ PROC_LINKS(kv_open_note_file, 0), false, "kv_open_note_file", 17, "switch to my note file", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 835 },
...
{ PROC_LINKS(kv_reopen_with_confirmation, 0), false, "kv_reopen_with_confirmation", 27, "Like reopen, but asks for confirmation", 38, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 457 },
{ PROC_LINKS(kv_run, 0), false, "kv_run", 6, "run the current script", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 824 },
...
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Replace (in all editable buffers)", 33, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1249 },
...
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2338 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2344 },
...
{ PROC_LINKS(switch_to_game_panel, 0), false, "switch_to_game_panel", 20, "switch to game panel", 20, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 841 },
...
{ PROC_LINKS(vim_jump_lister, 0), true, "vim_jump_lister", 15, "Opens an interactive lists of the views jumps", 45, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_vim/4coder_vim_lists.cpp", 65, 459 },
{ PROC_LINKS(vim_list_all_functions_current_buffer_lister, 0), true, "vim_list_all_functions_current_buffer_lister", 44, "Creates a lister of locations that look like function definitions and declarations in the buffer.", 97, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_vim/4coder_vim_lists.cpp", 65, 382 },
{ PROC_LINKS(vim_proj_cmd_lister, 0), true, "vim_proj_cmd_lister", 19, "Opens an interactive list of all project commands.", 50, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_vim/4coder_vim_lists.cpp", 65, 400 },
...
{ PROC_LINKS(vim_switch_lister, 0), true, "vim_switch_lister", 17, "Opens an interactive list of all loaded buffers.", 48, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_vim/4coder_vim_lists.cpp", 65, 319 },
...
static i1 fcoder_metacmd_ID_fold_clear = 38;
static i1 fcoder_metacmd_ID_fold_pop_cursor = 39;
static i1 fcoder_metacmd_ID_fold_range = 40;
static i1 fcoder_metacmd_ID_fold_toggle_cursor = 41;
static i1 fcoder_metacmd_ID_game_disable = 42;
static i1 fcoder_metacmd_ID_game_enable = 43;
static i1 fcoder_metacmd_ID_go_to_user_directory = 44;
static i1 fcoder_metacmd_ID_goto_beginning_of_file = 45;
static i1 fcoder_metacmd_ID_goto_end_of_file = 46;
static i1 fcoder_metacmd_ID_goto_first_jump = 47;
static i1 fcoder_metacmd_ID_goto_first_jump_same_panel_sticky = 48;
static i1 fcoder_metacmd_ID_goto_line = 49;
static i1 fcoder_metacmd_ID_goto_next_jump_no_skips = 50;
static i1 fcoder_metacmd_ID_goto_prev_jump_no_skips = 51;
static i1 fcoder_metacmd_ID_hide_filebar = 52;
static i1 fcoder_metacmd_ID_hide_scrollbar = 53;
static i1 fcoder_metacmd_ID_if0_off = 54;
static i1 fcoder_metacmd_ID_increase_face_size = 55;
static i1 fcoder_metacmd_ID_init = 56;
static i1 fcoder_metacmd_ID_interactive_kill_buffer = 57;
static i1 fcoder_metacmd_ID_interactive_new = 58;
static i1 fcoder_metacmd_ID_interactive_open = 59;
static i1 fcoder_metacmd_ID_interactive_open_or_new = 60;
static i1 fcoder_metacmd_ID_interactive_switch_buffer = 61;
static i1 fcoder_metacmd_ID_jump_to_last_point = 62;
static i1 fcoder_metacmd_ID_keyboard_macro_finish_recording = 63;
static i1 fcoder_metacmd_ID_keyboard_macro_replay = 64;
static i1 fcoder_metacmd_ID_keyboard_macro_start_recording = 65;
static i1 fcoder_metacmd_ID_kill_buffer = 66;
static i1 fcoder_metacmd_ID_kv_miscellaneous_debug_command = 67;
static i1 fcoder_metacmd_ID_kv_open_note_file = 68;
static i1 fcoder_metacmd_ID_kv_profile_disable_and_inspect = 69;
static i1 fcoder_metacmd_ID_kv_reopen_with_confirmation = 70;
static i1 fcoder_metacmd_ID_kv_run = 71;
static i1 fcoder_metacmd_ID_left_adjust_view = 72;
static i1 fcoder_metacmd_ID_list_all_functions_all_buffers = 73;
static i1 fcoder_metacmd_ID_list_all_functions_all_buffers_lister = 74;
static i1 fcoder_metacmd_ID_list_all_functions_current_buffer = 75;
static i1 fcoder_metacmd_ID_list_all_functions_current_buffer_lister = 76;
static i1 fcoder_metacmd_ID_list_all_locations = 77;
static i1 fcoder_metacmd_ID_list_all_locations_case_insensitive = 78;
static i1 fcoder_metacmd_ID_list_all_substring_locations = 79;
static i1 fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 80;
static i1 fcoder_metacmd_ID_load_project = 81;
static i1 fcoder_metacmd_ID_load_project_current_dir = 82;
static i1 fcoder_metacmd_ID_load_theme_current_buffer = 83;
static i1 fcoder_metacmd_ID_load_themes_default_folder = 84;
static i1 fcoder_metacmd_ID_load_themes_hot_directory = 85;
static i1 fcoder_metacmd_ID_make_directory_query = 86;
static i1 fcoder_metacmd_ID_messages = 87;
static i1 fcoder_metacmd_ID_miblo_decrement_basic = 88;
static i1 fcoder_metacmd_ID_miblo_decrement_time_stamp = 89;
static i1 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 90;
static i1 fcoder_metacmd_ID_miblo_increment_basic = 91;
static i1 fcoder_metacmd_ID_miblo_increment_time_stamp = 92;
static i1 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 93;
static i1 fcoder_metacmd_ID_mouse_wheel_change_face_size = 94;
static i1 fcoder_metacmd_ID_mouse_wheel_scroll = 95;
static i1 fcoder_metacmd_ID_move_down = 96;
static i1 fcoder_metacmd_ID_move_down_10 = 97;
static i1 fcoder_metacmd_ID_move_down_textual = 98;
static i1 fcoder_metacmd_ID_move_down_to_blank_line = 99;
static i1 fcoder_metacmd_ID_move_down_to_blank_line_end = 100;
static i1 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 101;
static i1 fcoder_metacmd_ID_move_left = 102;
static i1 fcoder_metacmd_ID_move_line_down = 103;
static i1 fcoder_metacmd_ID_move_line_up = 104;
static i1 fcoder_metacmd_ID_move_right = 105;
static i1 fcoder_metacmd_ID_move_up = 106;
static i1 fcoder_metacmd_ID_move_up_10 = 107;
static i1 fcoder_metacmd_ID_move_up_to_blank_line = 108;
static i1 fcoder_metacmd_ID_move_up_to_blank_line_end = 109;
static i1 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 110;
static i1 fcoder_metacmd_ID_multi_paste = 111;
static i1 fcoder_metacmd_ID_multi_paste_interactive = 112;
static i1 fcoder_metacmd_ID_multi_paste_interactive_quick = 113;
static i1 fcoder_metacmd_ID_no_op = 114;
static i1 fcoder_metacmd_ID_open_all_code = 115;
static i1 fcoder_metacmd_ID_open_all_code_recursive = 116;
static i1 fcoder_metacmd_ID_open_file_in_quotes = 117;
static i1 fcoder_metacmd_ID_open_long_braces = 118;
static i1 fcoder_metacmd_ID_open_long_braces_break = 119;
static i1 fcoder_metacmd_ID_open_long_braces_semicolon = 120;
static i1 fcoder_metacmd_ID_open_matching_file_cpp = 121;
static i1 fcoder_metacmd_ID_open_matching_file_cpp_other_panel = 122;
static i1 fcoder_metacmd_ID_page_down = 123;
static i1 fcoder_metacmd_ID_page_up = 124;
static i1 fcoder_metacmd_ID_paste = 125;
static i1 fcoder_metacmd_ID_paste_next = 126;
static i1 fcoder_metacmd_ID_place_in_scope = 127;
static i1 fcoder_metacmd_ID_play_with_a_counter = 128;
static i1 fcoder_metacmd_ID_profile_clear = 129;
static i1 fcoder_metacmd_ID_profile_enable = 130;
static i1 fcoder_metacmd_ID_profile_inspect = 131;
static i1 fcoder_metacmd_ID_project_command_F1 = 132;
static i1 fcoder_metacmd_ID_project_command_F10 = 133;
static i1 fcoder_metacmd_ID_project_command_F11 = 134;
static i1 fcoder_metacmd_ID_project_command_F12 = 135;
static i1 fcoder_metacmd_ID_project_command_F13 = 136;
static i1 fcoder_metacmd_ID_project_command_F14 = 137;
static i1 fcoder_metacmd_ID_project_command_F15 = 138;
static i1 fcoder_metacmd_ID_project_command_F16 = 139;
static i1 fcoder_metacmd_ID_project_command_F2 = 140;
static i1 fcoder_metacmd_ID_project_command_F3 = 141;
static i1 fcoder_metacmd_ID_project_command_F4 = 142;
static i1 fcoder_metacmd_ID_project_command_F5 = 143;
static i1 fcoder_metacmd_ID_project_command_F6 = 144;
static i1 fcoder_metacmd_ID_project_command_F7 = 145;
static i1 fcoder_metacmd_ID_project_command_F8 = 146;
static i1 fcoder_metacmd_ID_project_command_F9 = 147;
static i1 fcoder_metacmd_ID_project_command_lister = 148;
static i1 fcoder_metacmd_ID_project_fkey_command = 149;
static i1 fcoder_metacmd_ID_project_go_to_root_directory = 150;
static i1 fcoder_metacmd_ID_project_reprint = 151;
static i1 fcoder_metacmd_ID_query_replace = 152;
static i1 fcoder_metacmd_ID_query_replace_identifier = 153;
static i1 fcoder_metacmd_ID_query_replace_selection = 154;
static i1 fcoder_metacmd_ID_quick_swap_buffer = 155;
static i1 fcoder_metacmd_ID_redo_all_buffers = 156;
static i1 fcoder_metacmd_ID_reg = 157;
static i1 fcoder_metacmd_ID_rename_file_query = 158;
static i1 fcoder_metacmd_ID_reopen = 159;
static i1 fcoder_metacmd_ID_replace_in_all_buffers = 160;
static i1 fcoder_metacmd_ID_replace_in_buffer = 161;
static i1 fcoder_metacmd_ID_replace_in_range = 162;
static i1 fcoder_metacmd_ID_reverse_search = 163;
static i1 fcoder_metacmd_ID_reverse_search_identifier = 164;
static i1 fcoder_metacmd_ID_right_adjust_view = 165;
static i1 fcoder_metacmd_ID_save_all_dirty_buffers = 166;
static i1 fcoder_metacmd_ID_save_to_query = 167;
static i1 fcoder_metacmd_ID_scratch = 168;
static i1 fcoder_metacmd_ID_search = 169;
static i1 fcoder_metacmd_ID_search_identifier = 170;
static i1 fcoder_metacmd_ID_seek_beginning_of_textual_line = 171;
static i1 fcoder_metacmd_ID_seek_end_of_textual_line = 172;
static i1 fcoder_metacmd_ID_select_all = 173;
static i1 fcoder_metacmd_ID_select_next_scope_absolute = 174;
static i1 fcoder_metacmd_ID_select_next_scope_after_current = 175;
static i1 fcoder_metacmd_ID_select_prev_scope_absolute = 176;
static i1 fcoder_metacmd_ID_select_prev_top_most_scope = 177;
static i1 fcoder_metacmd_ID_select_surrounding_scope = 178;
static i1 fcoder_metacmd_ID_select_surrounding_scope_maximal = 179;
static i1 fcoder_metacmd_ID_set_current_dir_as_hot = 180;
static i1 fcoder_metacmd_ID_set_eol_mode_from_contents = 181;
static i1 fcoder_metacmd_ID_set_eol_mode_to_binary = 182;
static i1 fcoder_metacmd_ID_set_eol_mode_to_crlf = 183;
static i1 fcoder_metacmd_ID_set_eol_mode_to_lf = 184;
static i1 fcoder_metacmd_ID_set_face_size = 185;
static i1 fcoder_metacmd_ID_set_face_size_this_buffer = 186;
static i1 fcoder_metacmd_ID_set_mark = 187;
static i1 fcoder_metacmd_ID_set_mode_to_notepad_like = 188;
static i1 fcoder_metacmd_ID_set_mode_to_original = 189;
static i1 fcoder_metacmd_ID_show_filebar = 190;
static i1 fcoder_metacmd_ID_show_scrollbar = 191;
static i1 fcoder_metacmd_ID_show_the_log_graph = 192;
static i1 fcoder_metacmd_ID_snippet_lister = 193;
static i1 fcoder_metacmd_ID_suppress_mouse = 194;
static i1 fcoder_metacmd_ID_swap_panels = 195;
static i1 fcoder_metacmd_ID_switch_to_game_panel = 196;
static i1 fcoder_metacmd_ID_theme_lister = 197;
static i1 fcoder_metacmd_ID_toggle_filebar = 198;
static i1 fcoder_metacmd_ID_toggle_fps_meter = 199;
static i1 fcoder_metacmd_ID_toggle_fullscreen = 200;
static i1 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 201;
static i1 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 202;
static i1 fcoder_metacmd_ID_toggle_line_numbers = 203;
static i1 fcoder_metacmd_ID_toggle_line_wrap = 204;
...
static i1 fcoder_metacmd_ID_toggle_virtual_whitespace = 208;
static i1 fcoder_metacmd_ID_uncomment_line = 209;
static i1 fcoder_metacmd_ID_undo_all_buffers = 210;
static i1 fcoder_metacmd_ID_view_jump_list_with_lister = 211;
static i1 fcoder_metacmd_ID_vim_dec_buffer_peek = 212;
static i1 fcoder_metacmd_ID_vim_inc_buffer_peek = 213;
static i1 fcoder_metacmd_ID_vim_interactive_open_or_new = 214;
static i1 fcoder_metacmd_ID_vim_jump_lister = 215;
static i1 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 216;
static i1 fcoder_metacmd_ID_vim_proj_cmd_lister = 217;
static i1 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 218;
static i1 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 219;
static i1 fcoder_metacmd_ID_vim_switch_lister = 220;
static i1 fcoder_metacmd_ID_vim_theme_lister = 221;
static i1 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 222;
static i1 fcoder_metacmd_ID_vim_try_exit = 223;
static i1 fcoder_metacmd_ID_word_complete = 224;
static i1 fcoder_metacmd_ID_word_complete_drop_down = 225;
static i1 fcoder_metacmd_ID_write_block = 226;
static i1 fcoder_metacmd_ID_write_hack = 227;
static i1 fcoder_metacmd_ID_write_note = 228;
static i1 fcoder_metacmd_ID_write_text_and_auto_indent = 229;
static i1 fcoder_metacmd_ID_write_todo = 230;
static i1 fcoder_metacmd_ID_write_zero_struct = 231;
#endif
