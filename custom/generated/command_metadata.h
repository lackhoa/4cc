...
#define command_one_past_last_id 288
...
static Command_Metadata fcoder_metacmd_table[288] = {
...
{ PROC_LINKS(allow_mouse, 0), false, "allow_mouse", 11, "Shows the mouse and causes all mouse input to be processed normally.", 68, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 570 },
...
{ PROC_LINKS(basic_change_active_primary_panel, 0), false, "basic_change_active_primary_panel", 33, "Change the currently active panel, moving to the panel with the next highest view_id.  Will not skipe the build panel if it is open.", 132, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 668 },
...
{ PROC_LINKS(change_active_primary_panel_backwards, 0), false, "change_active_primary_panel_backwards", 37, "Change the currently active panel, moving to the panel with the next lowest view_id.", 84, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 451 },
...
{ PROC_LINKS(clear_all_themes, 0), false, "clear_all_themes", 16, "Clear the theme list", 20, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 654 },
...
{ PROC_LINKS(goto_next_jump_no_skips, 0), false, "goto_next_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, and does not skip sub jump locations.", 132, "C:\\Users\\vodan\\4ed/code/custom/4coder_jump_sticky.cpp", 53, 533 },
{ PROC_LINKS(goto_prev_jump_no_skips, 0), false, "goto_prev_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, and does not skip sub jump locations.", 136, "C:\\Users\\vodan\\4ed/code/custom/4coder_jump_sticky.cpp", 53, 550 },
...
{ PROC_LINKS(init, 0), false, "init", 4, "configure your editor!", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 807 },
...
{ PROC_LINKS(kv_miscellaneous_debug_command, 0), false, "kv_miscellaneous_debug_command", 30, "just a placeholder command so I can test stuff", 46, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 798 },
...
{ PROC_LINKS(load_themes_default_folder, 0), false, "load_themes_default_folder", 26, "Loads all the theme files in the default theme folder.", 54, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 624 },
{ PROC_LINKS(load_themes_hot_directory, 0), false, "load_themes_hot_directory", 25, "Loads all the theme files in the current hot directory.", 55, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 643 },
...
{ PROC_LINKS(open_panel_hsplit, 0), false, "open_panel_hsplit", 17, "Create a new panel by horizontally splitting the active panel.", 62, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 471 },
{ PROC_LINKS(open_panel_vsplit, 0), false, "open_panel_vsplit", 17, "Create a new panel by vertically splitting the active panel.", 60, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 461 },
...
{ PROC_LINKS(save_all_dirty_buffers, 0), false, "save_all_dirty_buffers", 22, "Saves all buffers marked dirty (showing the '*' indicator).", 59, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 543 },
...
{ PROC_LINKS(set_mode_to_notepad_like, 0), false, "set_mode_to_notepad_like", 24, "Sets the edit mode to Notepad like.", 35, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 588 },
{ PROC_LINKS(set_mode_to_original, 0), false, "set_mode_to_original", 20, "Sets the edit mode to 4coder original.", 38, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 582 },
...
{ PROC_LINKS(suppress_mouse, 0), false, "suppress_mouse", 14, "Hides the mouse and causes all mosue input (clicks, position, wheel) to be ignored.", 83, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 564 },
...
{ PROC_LINKS(toggle_fullscreen, 0), false, "toggle_fullscreen", 17, "Toggle fullscreen mode on or off.  The change(s) do not take effect until the next frame.", 89, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 618 },
{ PROC_LINKS(toggle_highlight_enclosing_scopes, 0), false, "toggle_highlight_enclosing_scopes", 33, "In code files scopes surrounding the cursor are highlighted with distinguishing colors.", 87, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 602 },
{ PROC_LINKS(toggle_highlight_line_at_cursor, 0), false, "toggle_highlight_line_at_cursor", 31, "Toggles the line highlight at the cursor.", 41, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 594 },
...
{ PROC_LINKS(toggle_mouse, 0), false, "toggle_mouse", 12, "Toggles the mouse suppression mode, see suppress_mouse and allow_mouse.", 71, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 576 },
{ PROC_LINKS(toggle_paren_matching_helper, 0), false, "toggle_paren_matching_helper", 28, "In code files matching parentheses pairs are colored with distinguishing colors.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 610 },
...
static i32 fcoder_metacmd_ID_increase_face_size = 67;
static i32 fcoder_metacmd_ID_init = 68;
...
static i32 fcoder_metacmd_ID_jump_to_definition_at_cursor = 75;
static i32 fcoder_metacmd_ID_jump_to_last_point = 76;
static i32 fcoder_metacmd_ID_keyboard_macro_finish_recording = 77;
static i32 fcoder_metacmd_ID_keyboard_macro_replay = 78;
static i32 fcoder_metacmd_ID_keyboard_macro_start_recording = 79;
static i32 fcoder_metacmd_ID_kill_buffer = 80;
static i32 fcoder_metacmd_ID_kill_tutorial = 81;
static i32 fcoder_metacmd_ID_kv_miscellaneous_debug_command = 82;
static i32 fcoder_metacmd_ID_kv_open_note_file = 83;
static i32 fcoder_metacmd_ID_kv_profile_disable_and_inspect = 84;
static i32 fcoder_metacmd_ID_kv_reopen_with_confirmation = 85;
static i32 fcoder_metacmd_ID_kv_run = 86;
static i32 fcoder_metacmd_ID_kv_view_input_handler = 87;
static i32 fcoder_metacmd_ID_left_adjust_view = 88;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers = 89;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers_lister = 90;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer = 91;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer_lister = 92;
static i32 fcoder_metacmd_ID_list_all_locations = 93;
static i32 fcoder_metacmd_ID_list_all_locations_case_insensitive = 94;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier = 95;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier_case_insensitive = 96;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection = 97;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection_case_insensitive = 98;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition = 99;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition_of_identifier = 100;
static i32 fcoder_metacmd_ID_list_all_substring_locations = 101;
static i32 fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 102;
static i32 fcoder_metacmd_ID_load_project = 103;
static i32 fcoder_metacmd_ID_load_project_current_dir = 104;
static i32 fcoder_metacmd_ID_load_theme_current_buffer = 105;
static i32 fcoder_metacmd_ID_load_themes_default_folder = 106;
static i32 fcoder_metacmd_ID_load_themes_hot_directory = 107;
static i32 fcoder_metacmd_ID_make_directory_query = 108;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 109;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 110;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 111;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 112;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 113;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 114;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 115;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 116;
static i32 fcoder_metacmd_ID_move_down = 117;
static i32 fcoder_metacmd_ID_move_down_10 = 118;
static i32 fcoder_metacmd_ID_move_down_textual = 119;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 120;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 121;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 122;
static i32 fcoder_metacmd_ID_move_left = 123;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 124;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 125;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 126;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 127;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 128;
static i32 fcoder_metacmd_ID_move_line_down = 129;
static i32 fcoder_metacmd_ID_move_line_up = 130;
static i32 fcoder_metacmd_ID_move_right = 131;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 132;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 133;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 134;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 135;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 136;
static i32 fcoder_metacmd_ID_move_up = 137;
static i32 fcoder_metacmd_ID_move_up_10 = 138;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 139;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 140;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 141;
static i32 fcoder_metacmd_ID_multi_paste = 142;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 143;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 144;
static i32 fcoder_metacmd_ID_music_start = 145;
static i32 fcoder_metacmd_ID_music_stop = 146;
static i32 fcoder_metacmd_ID_no_op = 147;
...
static i32 fcoder_metacmd_ID_open_matching_file_cpp_other_panel = 156;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 157;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 158;
static i32 fcoder_metacmd_ID_page_down = 159;
static i32 fcoder_metacmd_ID_page_up = 160;
static i32 fcoder_metacmd_ID_paste = 161;
static i32 fcoder_metacmd_ID_paste_and_indent = 162;
static i32 fcoder_metacmd_ID_paste_next = 163;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 164;
static i32 fcoder_metacmd_ID_place_in_scope = 165;
static i32 fcoder_metacmd_ID_play_with_a_counter = 166;
static i32 fcoder_metacmd_ID_profile_clear = 167;
static i32 fcoder_metacmd_ID_profile_disable = 168;
static i32 fcoder_metacmd_ID_profile_enable = 169;
static i32 fcoder_metacmd_ID_profile_inspect = 170;
static i32 fcoder_metacmd_ID_project_command_F1 = 171;
static i32 fcoder_metacmd_ID_project_command_F10 = 172;
static i32 fcoder_metacmd_ID_project_command_F11 = 173;
static i32 fcoder_metacmd_ID_project_command_F12 = 174;
static i32 fcoder_metacmd_ID_project_command_F13 = 175;
static i32 fcoder_metacmd_ID_project_command_F14 = 176;
static i32 fcoder_metacmd_ID_project_command_F15 = 177;
static i32 fcoder_metacmd_ID_project_command_F16 = 178;
static i32 fcoder_metacmd_ID_project_command_F2 = 179;
static i32 fcoder_metacmd_ID_project_command_F3 = 180;
static i32 fcoder_metacmd_ID_project_command_F4 = 181;
static i32 fcoder_metacmd_ID_project_command_F5 = 182;
static i32 fcoder_metacmd_ID_project_command_F6 = 183;
static i32 fcoder_metacmd_ID_project_command_F7 = 184;
static i32 fcoder_metacmd_ID_project_command_F8 = 185;
static i32 fcoder_metacmd_ID_project_command_F9 = 186;
static i32 fcoder_metacmd_ID_project_command_lister = 187;
static i32 fcoder_metacmd_ID_project_fkey_command = 188;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 189;
static i32 fcoder_metacmd_ID_project_reprint = 190;
static i32 fcoder_metacmd_ID_query_replace = 191;
static i32 fcoder_metacmd_ID_query_replace_identifier = 192;
static i32 fcoder_metacmd_ID_query_replace_selection = 193;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 194;
static i32 fcoder_metacmd_ID_redo = 195;
static i32 fcoder_metacmd_ID_redo_all_buffers = 196;
static i32 fcoder_metacmd_ID_reg = 197;
...
static i32 fcoder_metacmd_ID_right_adjust_view = 205;
...
static i32 fcoder_metacmd_ID_toggle_filebar = 246;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 247;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 248;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 249;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 250;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 251;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 252;
static i32 fcoder_metacmd_ID_toggle_mouse = 253;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 254;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 255;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 256;
static i32 fcoder_metacmd_ID_tutorial_maximize = 257;
static i32 fcoder_metacmd_ID_tutorial_minimize = 258;
static i32 fcoder_metacmd_ID_uncomment_line = 259;
static i32 fcoder_metacmd_ID_undo = 260;
static i32 fcoder_metacmd_ID_undo_all_buffers = 261;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 262;
static i32 fcoder_metacmd_ID_vim_command_mode = 263;
static i32 fcoder_metacmd_ID_vim_dec_buffer_peek = 264;
static i32 fcoder_metacmd_ID_vim_inc_buffer_peek = 265;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 266;
static i32 fcoder_metacmd_ID_vim_jump_lister = 267;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 268;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 269;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 270;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 271;
static i32 fcoder_metacmd_ID_vim_switch_lister = 272;
static i32 fcoder_metacmd_ID_vim_theme_lister = 273;
static i32 fcoder_metacmd_ID_vim_toggle_relative_line_num = 274;
static i32 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 275;
static i32 fcoder_metacmd_ID_vim_try_exit = 276;
static i32 fcoder_metacmd_ID_word_complete = 277;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 278;
static i32 fcoder_metacmd_ID_write_block = 279;
static i32 fcoder_metacmd_ID_write_hack = 280;
static i32 fcoder_metacmd_ID_write_note = 281;
static i32 fcoder_metacmd_ID_write_space = 282;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 283;
static i32 fcoder_metacmd_ID_write_text_input = 284;
static i32 fcoder_metacmd_ID_write_todo = 285;
static i32 fcoder_metacmd_ID_write_underscore = 286;
static i32 fcoder_metacmd_ID_write_zero_struct = 287;
#endif
