...
#define command_one_past_last_id 283
...
static Command_Metadata fcoder_metacmd_table[283] = {
...
{ PROC_LINKS(To_uppercase, 0), false, "To_uppercase", 12, "Converts all ascii text in the range between the cursor and the mark to uppercase.", 82, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 557 },
...
{ PROC_LINKS(basic_change_active_primary_panel, 0), false, "basic_change_active_primary_panel", 33, "Change the currently active panel, moving to the panel with the next highest view_id.  Will not skipe the build panel if it is open.", 132, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 669 },
...
{ PROC_LINKS(clean_all_lines, 0), false, "clean_all_lines", 15, "Removes trailing whitespace from all lines and removes all blank lines in the current buffer.", 93, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 649 },
{ PROC_LINKS(clean_trailing_whitespace, 0), false, "clean_trailing_whitespace", 25, "Removes trailing whitespace from all lines in the current buffer.", 65, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 658 },
...
{ PROC_LINKS(decrease_face_size, 0), false, "decrease_face_size", 18, "Decrease the size of the face used by the current buffer.", 57, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 753 },
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 2104 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1406 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1578 },
...
{ PROC_LINKS(dir, 0), false, "dir", 3, "kv copy dir name", 16, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 634 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1564 },
...
{ PROC_LINKS(exit_4coder, 0), false, "exit_4coder", 11, "Attempts to close 4coder.", 25, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 842 },
...
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2392 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2400 },
...
{ PROC_LINKS(goto_line, 0), false, "goto_line", 9, "Queries the user for a number, and jumps the cursor to the corresponding line.", 78, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 850 },
...
{ PROC_LINKS(hide_filebar, 0), false, "hide_filebar", 12, "Sets the current view to hide it's filebar.", 43, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 700 },
{ PROC_LINKS(hide_scrollbar, 0), false, "hide_scrollbar", 14, "Sets the current view to hide it's scrollbar.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 686 },
...
{ PROC_LINKS(increase_face_size, 0), false, "increase_face_size", 18, "Increase the size of the face used by the current buffer.", 57, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 742 },
{ PROC_LINKS(init, 0), false, "init", 4, "configure your editor!", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 808 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1358 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1765 },
{ PROC_LINKS(kv_miscellaneous_debug_command, 0), false, "kv_miscellaneous_debug_command", 30, "just a placeholder command so I can test stuff", 46, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 799 },
{ PROC_LINKS(kv_open_note_file, 0), false, "kv_open_note_file", 17, "switch to my note file", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 628 },
...
{ PROC_LINKS(kv_run, 0), false, "kv_run", 6, "run the current script", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 617 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1518 },
{ PROC_LINKS(messages, 0), false, "messages", 8, "switch to messages buffer", 25, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 924 },
...
{ PROC_LINKS(mouse_wheel_change_face_size, 0), false, "mouse_wheel_change_face_size", 28, "Reads the state of the mouse wheel and uses it to either increase or decrease the face size.", 92, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 795 },
...
{ PROC_LINKS(move_down, 0), false, "move_down", 9, "Moves the cursor down one line.", 31, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 343 },
{ PROC_LINKS(move_down_10, 0), false, "move_down_10", 12, "Moves the cursor down ten lines.", 32, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 355 },
{ PROC_LINKS(move_down_textual, 0), false, "move_down_textual", 17, "Moves down to the next line of actual text, regardless of line wrapping.", 72, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 361 },
{ PROC_LINKS(move_down_to_blank_line, 0), false, "move_down_to_blank_line", 23, "Seeks the cursor down to the next blank line.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 414 },
{ PROC_LINKS(move_down_to_blank_line_end, 0), false, "move_down_to_blank_line_end", 27, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 438 },
{ PROC_LINKS(move_down_to_blank_line_skip_whitespace, 0), false, "move_down_to_blank_line_skip_whitespace", 39, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 426 },
{ PROC_LINKS(move_left, 0), false, "move_left", 9, "Moves the cursor one character to the left.", 43, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 444 },
{ PROC_LINKS(move_left_alpha_numeric_boundary, 0), false, "move_left_alpha_numeric_boundary", 32, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 521 },
{ PROC_LINKS(move_left_alpha_numeric_or_camel_boundary, 0), false, "move_left_alpha_numeric_or_camel_boundary", 41, "Seek left for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 106, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 535 },
{ PROC_LINKS(move_left_token_boundary, 0), false, "move_left_token_boundary", 24, "Seek left for the next beginning of a token.", 44, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 493 },
{ PROC_LINKS(move_left_whitespace_boundary, 0), false, "move_left_whitespace_boundary", 29, "Seek left for the next boundary between whitespace and non-whitespace.", 70, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 478 },
{ PROC_LINKS(move_left_whitespace_or_token_boundary, 0), false, "move_left_whitespace_or_token_boundary", 38, "Seek left for the next end of a token or boundary between whitespace and non-whitespace.", 88, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 507 },
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1558 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1552 },
{ PROC_LINKS(move_right, 0), false, "move_right", 10, "Moves the cursor one character to the right.", 44, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 452 },
{ PROC_LINKS(move_right_alpha_numeric_boundary, 0), false, "move_right_alpha_numeric_boundary", 33, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 514 },
{ PROC_LINKS(move_right_alpha_numeric_or_camel_boundary, 0), false, "move_right_alpha_numeric_or_camel_boundary", 42, "Seek right for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 107, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 528 },
{ PROC_LINKS(move_right_token_boundary, 0), false, "move_right_token_boundary", 25, "Seek right for the next end of a token.", 39, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 486 },
{ PROC_LINKS(move_right_whitespace_boundary, 0), false, "move_right_whitespace_boundary", 30, "Seek right for the next boundary between whitespace and non-whitespace.", 71, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 470 },
{ PROC_LINKS(move_right_whitespace_or_token_boundary, 0), false, "move_right_whitespace_or_token_boundary", 39, "Seek right for the next end of a token or boundary between whitespace and non-whitespace.", 89, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 500 },
{ PROC_LINKS(move_up, 0), false, "move_up", 7, "Moves the cursor up one line.", 29, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 337 },
{ PROC_LINKS(move_up_10, 0), false, "move_up_10", 10, "Moves the cursor up ten lines.", 30, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 349 },
{ PROC_LINKS(move_up_to_blank_line, 0), false, "move_up_to_blank_line", 21, "Seeks the cursor up to the next blank line.", 43, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 408 },
{ PROC_LINKS(move_up_to_blank_line_end, 0), false, "move_up_to_blank_line_end", 25, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 432 },
{ PROC_LINKS(move_up_to_blank_line_skip_whitespace, 0), false, "move_up_to_blank_line_skip_whitespace", 37, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 420 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1599 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 2098 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file.", 92, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1686 },
{ PROC_LINKS(open_matching_file_cpp_other_panel, 0), false, "open_matching_file_cpp_other_panel", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1698 },
...
{ PROC_LINKS(page_down, 0), false, "page_down", 9, "Scrolls the view down one view height and moves the cursor down one view height.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 379 },
{ PROC_LINKS(page_up, 0), false, "page_up", 7, "Scrolls the view up one view height and moves the cursor up one view height.", 76, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 371 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1304 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1325 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1341 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1745 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1925 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 2022 },
...
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1483 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1783 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1213 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1204 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1195 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1136 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1148 },
...
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1773 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1450 },
{ PROC_LINKS(scratch, 0), false, "scratch", 7, "switch to scratch buffer", 24, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 918 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1130 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1142 },
{ PROC_LINKS(seek_beginning_of_line, 0), false, "seek_beginning_of_line", 22, "Seeks the cursor to the beginning of the visual line.", 53, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2380 },
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2368 },
{ PROC_LINKS(seek_end_of_line, 0), false, "seek_end_of_line", 16, "Seeks the cursor to the end of the visual line.", 47, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2386 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "C:\\Users\\vodan\\4ed/code/custom/4coder_helper.cpp", 48, 2374 },
{ PROC_LINKS(select_all, 0), false, "select_all", 10, "Puts the cursor at the top of the file, and the mark at the bottom of the file.", 79, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 544 },
...
{ PROC_LINKS(set_current_dir_as_hot, 0), false, "set_current_dir_as_hot", 22, "set current dir as hot", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 909 },
...
{ PROC_LINKS(set_face_size, 0), false, "set_face_size", 13, "Set face size of the face used by the current buffer.", 53, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 722 },
{ PROC_LINKS(set_face_size_this_buffer, 0), false, "set_face_size_this_buffer", 25, "Set face size of the face used by the current buffer; if any other buffers are using the same face a new face is created so that only this buffer is effected", 157, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 764 },
...
{ PROC_LINKS(show_filebar, 0), false, "show_filebar", 12, "Sets the current view to show it's filebar.", 43, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 693 },
{ PROC_LINKS(show_scrollbar, 0), false, "show_scrollbar", 14, "Sets the current view to show it's scrollbar.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 679 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1723 },
...
{ PROC_LINKS(to_lowercase, 0), false, "to_lowercase", 12, "Converts all ascii text in the range between the cursor and the mark to lowercase.", 82, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 570 },
{ PROC_LINKS(toggle_filebar, 0), false, "toggle_filebar", 14, "Toggles the visibility status of the current view's filebar.", 60, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 707 },
{ PROC_LINKS(toggle_fps_meter, 0), false, "toggle_fps_meter", 16, "Toggles the visibility of the FPS performance meter", 51, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 716 },
...
{ PROC_LINKS(toggle_line_numbers, 0), false, "toggle_line_numbers", 19, "Toggles the left margin line numbers.", 37, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 821 },
{ PROC_LINKS(toggle_line_wrap, 0), false, "toggle_line_wrap", 16, "Toggles the line wrap setting on this buffer.", 45, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 829 },
...
{ PROC_LINKS(toggle_show_whitespace, 0), false, "toggle_show_whitespace", 22, "Toggles the current buffer's whitespace visibility status.", 58, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 812 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1873 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "C:\\Users\\vodan\\4ed/code/custom/4coder_base_commands.cpp", 55, 1951 },
...
static i32 fcoder_metacmd_ID_basic_change_active_primary_panel = 8;
...
static i32 fcoder_metacmd_ID_change_active_primary_panel_backwards = 13;
...
static i32 fcoder_metacmd_ID_dir = 41;
static i32 fcoder_metacmd_ID_display_key_codes = 42;
static i32 fcoder_metacmd_ID_display_text_input = 43;
static i32 fcoder_metacmd_ID_double_backspace = 44;
static i32 fcoder_metacmd_ID_duplicate_line = 45;
static i32 fcoder_metacmd_ID_execute_any_cli = 46;
static i32 fcoder_metacmd_ID_execute_previous_cli = 47;
static i32 fcoder_metacmd_ID_exit_4coder = 48;
static i32 fcoder_metacmd_ID_fold_clear = 49;
static i32 fcoder_metacmd_ID_fold_pop_cursor = 50;
static i32 fcoder_metacmd_ID_fold_range = 51;
static i32 fcoder_metacmd_ID_fold_toggle_cursor = 52;
...
static i32 fcoder_metacmd_ID_hit_sfx = 64;
static i32 fcoder_metacmd_ID_if0_off = 65;
static i32 fcoder_metacmd_ID_increase_face_size = 66;
static i32 fcoder_metacmd_ID_init = 67;
static i32 fcoder_metacmd_ID_interactive_kill_buffer = 68;
static i32 fcoder_metacmd_ID_interactive_new = 69;
static i32 fcoder_metacmd_ID_interactive_open = 70;
static i32 fcoder_metacmd_ID_interactive_open_or_new = 71;
static i32 fcoder_metacmd_ID_interactive_switch_buffer = 72;
...
static i32 fcoder_metacmd_ID_kill_buffer = 77;
static i32 fcoder_metacmd_ID_kv_miscellaneous_debug_command = 78;
static i32 fcoder_metacmd_ID_kv_open_note_file = 79;
static i32 fcoder_metacmd_ID_kv_profile_disable_and_inspect = 80;
static i32 fcoder_metacmd_ID_kv_reopen_with_confirmation = 81;
static i32 fcoder_metacmd_ID_kv_run = 82;
...
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier_case_insensitive = 90;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection = 91;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection_case_insensitive = 92;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition = 93;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition_of_identifier = 94;
static i32 fcoder_metacmd_ID_list_all_substring_locations = 95;
static i32 fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 96;
static i32 fcoder_metacmd_ID_load_project = 97;
static i32 fcoder_metacmd_ID_load_project_current_dir = 98;
...
static i32 fcoder_metacmd_ID_messages = 103;
...
static i32 fcoder_metacmd_ID_no_op = 142;
...
static i32 fcoder_metacmd_ID_open_matching_file_cpp_other_panel = 151;
...
static i32 fcoder_metacmd_ID_reg = 192;
static i32 fcoder_metacmd_ID_rename_file_query = 193;
static i32 fcoder_metacmd_ID_reopen = 194;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 195;
static i32 fcoder_metacmd_ID_replace_in_buffer = 196;
static i32 fcoder_metacmd_ID_replace_in_range = 197;
static i32 fcoder_metacmd_ID_reverse_search = 198;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 199;
static i32 fcoder_metacmd_ID_right_adjust_view = 200;
...
static i32 fcoder_metacmd_ID_scratch = 204;
static i32 fcoder_metacmd_ID_search = 205;
static i32 fcoder_metacmd_ID_search_identifier = 206;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 207;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 208;
static i32 fcoder_metacmd_ID_seek_end_of_line = 209;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 210;
static i32 fcoder_metacmd_ID_select_all = 211;
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 212;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 213;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 214;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 215;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 216;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 217;
static i32 fcoder_metacmd_ID_set_current_dir_as_hot = 218;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 219;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 220;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 221;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 222;
static i32 fcoder_metacmd_ID_set_face_size = 223;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 224;
static i32 fcoder_metacmd_ID_set_mark = 225;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 226;
static i32 fcoder_metacmd_ID_set_mode_to_original = 227;
static i32 fcoder_metacmd_ID_setup_build_bat = 228;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 229;
static i32 fcoder_metacmd_ID_setup_build_sh = 230;
static i32 fcoder_metacmd_ID_setup_new_project = 231;
static i32 fcoder_metacmd_ID_show_filebar = 232;
static i32 fcoder_metacmd_ID_show_scrollbar = 233;
static i32 fcoder_metacmd_ID_show_the_log_graph = 234;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 235;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 236;
static i32 fcoder_metacmd_ID_snippet_lister = 237;
static i32 fcoder_metacmd_ID_string_repeat = 238;
static i32 fcoder_metacmd_ID_suppress_mouse = 239;
static i32 fcoder_metacmd_ID_swap_panels = 240;
static i32 fcoder_metacmd_ID_theme_lister = 241;
static i32 fcoder_metacmd_ID_to_lowercase = 242;
static i32 fcoder_metacmd_ID_toggle_filebar = 243;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 244;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 245;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 246;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 247;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 248;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 249;
static i32 fcoder_metacmd_ID_toggle_mouse = 250;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 251;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 252;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 253;
...
static i32 fcoder_metacmd_ID_vim_command_mode = 258;
static i32 fcoder_metacmd_ID_vim_dec_buffer_peek = 259;
static i32 fcoder_metacmd_ID_vim_inc_buffer_peek = 260;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 261;
static i32 fcoder_metacmd_ID_vim_jump_lister = 262;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 263;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 264;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 265;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 266;
static i32 fcoder_metacmd_ID_vim_switch_lister = 267;
static i32 fcoder_metacmd_ID_vim_theme_lister = 268;
static i32 fcoder_metacmd_ID_vim_toggle_relative_line_num = 269;
static i32 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 270;
static i32 fcoder_metacmd_ID_vim_try_exit = 271;
static i32 fcoder_metacmd_ID_word_complete = 272;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 273;
static i32 fcoder_metacmd_ID_write_block = 274;
static i32 fcoder_metacmd_ID_write_hack = 275;
static i32 fcoder_metacmd_ID_write_note = 276;
static i32 fcoder_metacmd_ID_write_space = 277;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 278;
static i32 fcoder_metacmd_ID_write_text_input = 279;
static i32 fcoder_metacmd_ID_write_todo = 280;
static i32 fcoder_metacmd_ID_write_underscore = 281;
static i32 fcoder_metacmd_ID_write_zero_struct = 282;
#endif
