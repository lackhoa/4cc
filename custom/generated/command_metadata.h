...
{ PROC_LINKS(allow_mouse, 0), false, "allow_mouse", 11, "Shows the mouse and causes all mouse input to be processed normally.", 68, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 525 },
{ PROC_LINKS(are_we_in_debug_build, 0), false, "are_we_in_debug_build", 21, "", 0, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1206 },
...
{ PROC_LINKS(clear_all_themes, 0), false, "clear_all_themes", 16, "Clear the theme list", 20, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 609 },
...
{ PROC_LINKS(init, 0), false, "init", 4, "configure your editor!", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 988 },
...
{ PROC_LINKS(kv_miscellaneous_debug_command, 0), false, "kv_miscellaneous_debug_command", 30, "just a placeholder command so I can test stuff", 46, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 983 },
...
{ PROC_LINKS(load_themes_default_folder, 0), false, "load_themes_default_folder", 26, "Loads all the theme files in the default theme folder.", 54, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 579 },
{ PROC_LINKS(load_themes_hot_directory, 0), false, "load_themes_hot_directory", 25, "Loads all the theme files in the current hot directory.", 55, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 598 },
...
{ PROC_LINKS(messages, 0), false, "messages", 8, "switch to messages buffer", 25, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1086 },
...
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Replace (in all editable buffers)", 33, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1256 },
...
{ PROC_LINKS(save_all_dirty_buffers, 0), false, "save_all_dirty_buffers", 22, "Saves all buffers marked dirty (showing the '*' indicator).", 59, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 498 },
...
{ PROC_LINKS(scratch, 0), false, "scratch", 7, "switch to scratch buffer", 24, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1080 },
...
{ PROC_LINKS(set_current_dir_as_hot, 0), false, "set_current_dir_as_hot", 22, "set current dir as hot", 22, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 1071 },
...
{ PROC_LINKS(set_mode_to_notepad_like, 0), false, "set_mode_to_notepad_like", 24, "Sets the edit mode to Notepad like.", 35, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 543 },
{ PROC_LINKS(set_mode_to_original, 0), false, "set_mode_to_original", 20, "Sets the edit mode to 4coder original.", 38, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 537 },
...
{ PROC_LINKS(suppress_mouse, 0), false, "suppress_mouse", 14, "Hides the mouse and causes all mosue input (clicks, position, wheel) to be ignored.", 83, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 519 },
...
{ PROC_LINKS(switch_to_game_panel, 0), false, "switch_to_game_panel", 20, "switch to game panel", 20, "C:\\Users\\vodan\\4ed\\code\\4coder_kv/4coder_kv_commands.cpp", 56, 848 },
...
{ PROC_LINKS(toggle_fullscreen, 0), false, "toggle_fullscreen", 17, "Toggle fullscreen mode on or off.  The change(s) do not take effect until the next frame.", 89, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 573 },
{ PROC_LINKS(toggle_highlight_enclosing_scopes, 0), false, "toggle_highlight_enclosing_scopes", 33, "In code files scopes surrounding the cursor are highlighted with distinguishing colors.", 87, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 557 },
{ PROC_LINKS(toggle_highlight_line_at_cursor, 0), false, "toggle_highlight_line_at_cursor", 31, "Toggles the line highlight at the cursor.", 41, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 549 },
...
{ PROC_LINKS(toggle_mouse, 0), false, "toggle_mouse", 12, "Toggles the mouse suppression mode, see suppress_mouse and allow_mouse.", 71, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 531 },
{ PROC_LINKS(toggle_paren_matching_helper, 0), false, "toggle_paren_matching_helper", 28, "In code files matching parentheses pairs are colored with distinguishing colors.", 80, "C:\\Users\\vodan\\4ed/code/custom/4coder_default_framework.cpp", 59, 565 },
...
static i1 fcoder_metacmd_ID_toggle_mouse = 204;
static i1 fcoder_metacmd_ID_toggle_paren_matching_helper = 205;
static i1 fcoder_metacmd_ID_toggle_show_whitespace = 206;
static i1 fcoder_metacmd_ID_uncomment_line = 207;
static i1 fcoder_metacmd_ID_undo_all_buffers = 208;
static i1 fcoder_metacmd_ID_view_jump_list_with_lister = 209;
static i1 fcoder_metacmd_ID_vim_dec_buffer_peek = 210;
static i1 fcoder_metacmd_ID_vim_inc_buffer_peek = 211;
static i1 fcoder_metacmd_ID_vim_interactive_open_or_new = 212;
static i1 fcoder_metacmd_ID_vim_jump_lister = 213;
static i1 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 214;
static i1 fcoder_metacmd_ID_vim_proj_cmd_lister = 215;
static i1 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 216;
static i1 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 217;
static i1 fcoder_metacmd_ID_vim_switch_lister = 218;
static i1 fcoder_metacmd_ID_vim_theme_lister = 219;
static i1 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 220;
static i1 fcoder_metacmd_ID_vim_try_exit = 221;
static i1 fcoder_metacmd_ID_word_complete = 222;
static i1 fcoder_metacmd_ID_word_complete_drop_down = 223;
static i1 fcoder_metacmd_ID_write_block = 224;
static i1 fcoder_metacmd_ID_write_hack = 225;
static i1 fcoder_metacmd_ID_write_note = 226;
static i1 fcoder_metacmd_ID_write_text_and_auto_indent = 227;
static i1 fcoder_metacmd_ID_write_todo = 228;
static i1 fcoder_metacmd_ID_write_zero_struct = 229;
#endif
