...
#define command_one_past_last_id 315
...
static Command_Metadata fcoder_metacmd_table[315] = {
...
{ PROC_LINKS(kv_build_full_rebuild, 0), false, "kv_build_full_rebuild", 21, "Same as kv_build_search, only run", 33, "/Users/khoa/4ed/code/4coder_kv/4coder_kv_build.cpp", 50, 135 },
{ PROC_LINKS(kv_build_normal, 0), false, "kv_build_normal", 15, "Like build_search, but using my standard script names.", 54, "/Users/khoa/4ed/code/4coder_kv/4coder_kv_build.cpp", 50, 123 },
{ PROC_LINKS(kv_build_run_only, 0), false, "kv_build_run_only", 17, "Same as kv_build_search, only run", 33, "/Users/khoa/4ed/code/4coder_kv/4coder_kv_build.cpp", 50, 129 },
...
static i32 fcoder_metacmd_ID_project_command_F1 = 188;
static i32 fcoder_metacmd_ID_project_command_F10 = 189;
static i32 fcoder_metacmd_ID_project_command_F11 = 190;
static i32 fcoder_metacmd_ID_project_command_F12 = 191;
static i32 fcoder_metacmd_ID_project_command_F13 = 192;
static i32 fcoder_metacmd_ID_project_command_F14 = 193;
static i32 fcoder_metacmd_ID_project_command_F15 = 194;
static i32 fcoder_metacmd_ID_project_command_F16 = 195;
static i32 fcoder_metacmd_ID_project_command_F2 = 196;
static i32 fcoder_metacmd_ID_project_command_F3 = 197;
static i32 fcoder_metacmd_ID_project_command_F4 = 198;
static i32 fcoder_metacmd_ID_project_command_F5 = 199;
static i32 fcoder_metacmd_ID_project_command_F6 = 200;
static i32 fcoder_metacmd_ID_project_command_F7 = 201;
static i32 fcoder_metacmd_ID_project_command_F8 = 202;
static i32 fcoder_metacmd_ID_project_command_F9 = 203;
static i32 fcoder_metacmd_ID_project_command_lister = 204;
static i32 fcoder_metacmd_ID_project_fkey_command = 205;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 206;
static i32 fcoder_metacmd_ID_project_reprint = 207;
static i32 fcoder_metacmd_ID_q = 208;
static i32 fcoder_metacmd_ID_qa = 209;
static i32 fcoder_metacmd_ID_qk = 210;
static i32 fcoder_metacmd_ID_query_replace = 211;
static i32 fcoder_metacmd_ID_query_replace_identifier = 212;
static i32 fcoder_metacmd_ID_query_replace_selection = 213;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 214;
static i32 fcoder_metacmd_ID_redo = 215;
static i32 fcoder_metacmd_ID_redo_all_buffers = 216;
static i32 fcoder_metacmd_ID_reg = 217;
static i32 fcoder_metacmd_ID_rename_file_query = 218;
static i32 fcoder_metacmd_ID_reopen = 219;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 220;
static i32 fcoder_metacmd_ID_replace_in_buffer = 221;
static i32 fcoder_metacmd_ID_replace_in_range = 222;
static i32 fcoder_metacmd_ID_reverse_search = 223;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 224;
static i32 fcoder_metacmd_ID_right_adjust_view = 225;
static i32 fcoder_metacmd_ID_s = 226;
static i32 fcoder_metacmd_ID_save = 227;
static i32 fcoder_metacmd_ID_save_all_dirty_buffers = 228;
static i32 fcoder_metacmd_ID_save_to_query = 229;
static i32 fcoder_metacmd_ID_search = 230;
static i32 fcoder_metacmd_ID_search_identifier = 231;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 232;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 233;
static i32 fcoder_metacmd_ID_seek_end_of_line = 234;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 235;
static i32 fcoder_metacmd_ID_select_all = 236;
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 237;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 238;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 239;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 240;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 241;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 242;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 243;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 244;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 245;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 246;
static i32 fcoder_metacmd_ID_set_face_size = 247;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 248;
static i32 fcoder_metacmd_ID_set_mark = 249;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 250;
static i32 fcoder_metacmd_ID_set_mode_to_original = 251;
static i32 fcoder_metacmd_ID_setup_build_bat = 252;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 253;
static i32 fcoder_metacmd_ID_setup_build_sh = 254;
static i32 fcoder_metacmd_ID_setup_new_project = 255;
static i32 fcoder_metacmd_ID_show_filebar = 256;
static i32 fcoder_metacmd_ID_show_scrollbar = 257;
static i32 fcoder_metacmd_ID_show_the_log_graph = 258;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 259;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 260;
static i32 fcoder_metacmd_ID_snippet_lister = 261;
static i32 fcoder_metacmd_ID_sp = 262;
static i32 fcoder_metacmd_ID_string_repeat = 263;
static i32 fcoder_metacmd_ID_suppress_mouse = 264;
static i32 fcoder_metacmd_ID_swap_panels = 265;
static i32 fcoder_metacmd_ID_theme_lister = 266;
static i32 fcoder_metacmd_ID_to_lowercase = 267;
...
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 277;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 278;
static i32 fcoder_metacmd_ID_tutorial_maximize = 279;
static i32 fcoder_metacmd_ID_tutorial_minimize = 280;
static i32 fcoder_metacmd_ID_uncomment_line = 281;
static i32 fcoder_metacmd_ID_undo = 282;
static i32 fcoder_metacmd_ID_undo_all_buffers = 283;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 284;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 285;
static i32 fcoder_metacmd_ID_vim_command_mode = 286;
static i32 fcoder_metacmd_ID_vim_dec_buffer_peek = 287;
static i32 fcoder_metacmd_ID_vim_inc_buffer_peek = 288;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 289;
static i32 fcoder_metacmd_ID_vim_jump_lister = 290;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 291;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 292;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 293;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 294;
static i32 fcoder_metacmd_ID_vim_switch_lister = 295;
static i32 fcoder_metacmd_ID_vim_theme_lister = 296;
static i32 fcoder_metacmd_ID_vim_toggle_relative_line_num = 297;
static i32 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 298;
static i32 fcoder_metacmd_ID_vim_try_exit = 299;
static i32 fcoder_metacmd_ID_vs = 300;
static i32 fcoder_metacmd_ID_w = 301;
static i32 fcoder_metacmd_ID_word_complete = 302;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 303;
static i32 fcoder_metacmd_ID_wq = 304;
static i32 fcoder_metacmd_ID_wqa = 305;
static i32 fcoder_metacmd_ID_write_block = 306;
static i32 fcoder_metacmd_ID_write_hack = 307;
static i32 fcoder_metacmd_ID_write_note = 308;
static i32 fcoder_metacmd_ID_write_space = 309;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 310;
static i32 fcoder_metacmd_ID_write_text_input = 311;
static i32 fcoder_metacmd_ID_write_todo = 312;
static i32 fcoder_metacmd_ID_write_underscore = 313;
static i32 fcoder_metacmd_ID_write_zero_struct = 314;
#endif
