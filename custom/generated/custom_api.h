...
#define custom_draw_rect_sig() void custom_draw_rect(Application_Links* app, Rect_f32 rect, f32 roundness, ARGB_Color color)
#define custom_draw_rect_outline_sig() void custom_draw_rect_outline(Application_Links* app, Rect_f32 rect, f32 roundness, f32 thickness, ARGB_Color color)
...
typedef void custom_draw_rect_type(Application_Links* app, Rect_f32 rect, f32 roundness, ARGB_Color color);
typedef void custom_draw_rect_outline_type(Application_Links* app, Rect_f32 rect, f32 roundness, f32 thickness, ARGB_Color color);
...
LINKAGE b32 global_set_setting(Application_Links* app, Global_Setting_ID setting, i64 value);
LINKAGE Rect_f32 global_get_screen_rectangle(Application_Links* app);
LINKAGE Thread_Context* get_thread_context(Application_Links* app);
LINKAGE Child_Process_ID create_child_process(Application_Links* app, String_Const_u8 path, String_Const_u8 command);
LINKAGE b32 child_process_set_target_buffer(Application_Links* app, Child_Process_ID child_process_id, Buffer_ID buffer_id, Child_Process_Set_Target_Flags flags);
LINKAGE Child_Process_ID buffer_get_attached_child_process(Application_Links* app, Buffer_ID buffer_id);
LINKAGE Buffer_ID child_process_get_attached_buffer(Application_Links* app, Child_Process_ID child_process_id);
LINKAGE Process_State child_process_get_state(Application_Links* app, Child_Process_ID child_process_id);
LINKAGE b32 enqueue_virtual_event(Application_Links* app, Input_Event* event);
...
LINKAGE i64 buffer_pos_at_relative_xy(Application_Links* app, Buffer_ID buffer_id, f32 width, Face_ID face_id, i64 base_line, Vec2_f32 relative_xy);
LINKAGE Rect_f32 buffer_relative_box_of_pos(Application_Links* app, Buffer_ID buffer_id, f32 width, Face_ID face_id, i64 base_line, i64 pos);
LINKAGE Rect_f32 buffer_padded_box_of_pos(Application_Links* app, Buffer_ID buffer_id, f32 width, Face_ID face_id, i64 base_line, i64 pos);
LINKAGE i64 buffer_relative_character_from_pos(Application_Links* app, Buffer_ID buffer_id, f32 width, Face_ID face_id, i64 base_line, i64 pos);
LINKAGE i64 buffer_pos_from_relative_character(Application_Links* app, Buffer_ID buffer_id, f32 width, Face_ID face_id, i64 base_line, i64 relative_character);
LINKAGE f32 view_line_y_difference(Application_Links* app, View_ID view_id, i64 line_a, i64 line_b);
LINKAGE Line_Shift_Vertical view_line_shift_y(Application_Links* app, View_ID view_id, i64 line, f32 y_shift);
LINKAGE i64 view_pos_at_relative_xy(Application_Links* app, View_ID view_id, i64 base_line, Vec2_f32 relative_xy);
LINKAGE Rect_f32 view_relative_box_of_pos(Application_Links* app, View_ID view_id, i64 base_line, i64 pos);
LINKAGE Rect_f32 view_padded_box_of_pos(Application_Links* app, View_ID view_id, i64 base_line, i64 pos);
LINKAGE i64 view_relative_character_from_pos(Application_Links* app, View_ID view_id, i64 base_line, i64 pos);
LINKAGE i64 view_pos_from_relative_character(Application_Links* app, View_ID view_id, i64 base_line, i64 character);
LINKAGE b32 buffer_exists(Application_Links* app, Buffer_ID buffer_id);
LINKAGE Access_Flag buffer_get_access_flags(Application_Links* app, Buffer_ID buffer_id);
LINKAGE i64 buffer_get_size(Application_Links* app, Buffer_ID buffer_id);
...
LINKAGE b32 buffer_clear_layout_cache(Application_Links* app, Buffer_ID buffer_id);
LINKAGE Layout_Function* buffer_get_layout(Application_Links* app, Buffer_ID buffer_id);
LINKAGE b32 buffer_get_setting(Application_Links* app, Buffer_ID buffer_id, Buffer_Setting_ID setting, i64* value_out);
...
LINKAGE View_ID get_view_next(Application_Links* app, View_ID view_id, Access_Flag access);
LINKAGE View_ID get_view_prev(Application_Links* app, View_ID view_id, Access_Flag access);
LINKAGE View_ID get_this_ctx_view(Application_Links* app, Access_Flag access);
LINKAGE View_ID get_active_view(Application_Links* app, Access_Flag access);
LINKAGE b32 view_exists(Application_Links* app, View_ID view_id);
LINKAGE Buffer_ID view_get_buffer(Application_Links* app, View_ID view_id, Access_Flag access);
LINKAGE i64 view_get_cursor_pos(Application_Links* app, View_ID view_id);
LINKAGE i64 view_get_mark_pos(Application_Links* app, View_ID view_id);
LINKAGE f32 view_get_preferred_x(Application_Links* app, View_ID view_id);
LINKAGE b32 view_set_preferred_x(Application_Links* app, View_ID view_id, f32 x);
LINKAGE Rect_f32 view_get_screen_rect(Application_Links* app, View_ID view_id);
LINKAGE Panel_ID view_get_panel(Application_Links* app, View_ID view_id);
LINKAGE View_ID panel_get_view(Application_Links* app, Panel_ID panel_id, Access_Flag access);
LINKAGE b32 panel_is_split(Application_Links* app, Panel_ID panel_id);
LINKAGE b32 panel_is_leaf(Application_Links* app, Panel_ID panel_id);
LINKAGE b32 panel_split(Application_Links* app, Panel_ID panel_id, Dimension split_dim);
LINKAGE b32 panel_set_split(Application_Links* app, Panel_ID panel_id, Panel_Split_Kind kind, f32 t);
LINKAGE b32 panel_swap_children(Application_Links* app, Panel_ID panel_id);
LINKAGE Panel_ID panel_get_root(Application_Links* app);
LINKAGE Panel_ID panel_get_parent(Application_Links* app, Panel_ID panel_id);
LINKAGE Panel_ID panel_get_child(Application_Links* app, Panel_ID panel_id, Side which_child);
LINKAGE b32 view_close(Application_Links* app, View_ID view_id);
LINKAGE Rect_f32 view_get_buffer_region(Application_Links* app, View_ID view_id);
LINKAGE Buffer_Scroll view_get_buffer_scroll(Application_Links* app, View_ID view_id);
LINKAGE b32 view_set_active(Application_Links* app, View_ID view_id);
LINKAGE b32 view_enqueue_command_function(Application_Links* app, View_ID view_id, Custom_Command_Function* custom_func);
LINKAGE b32 view_get_setting(Application_Links* app, View_ID view_id, View_Setting_ID setting, i64* value_out);
LINKAGE b32 view_set_setting(Application_Links* app, View_ID view_id, View_Setting_ID setting, i64 value);
LINKAGE Managed_Scope view_get_managed_scope(Application_Links* app, View_ID view_id);
LINKAGE Buffer_Cursor buffer_compute_cursor(Application_Links* app, Buffer_ID buffer, Buffer_Seek seek);
LINKAGE Buffer_Cursor view_compute_cursor(Application_Links* app, View_ID view_id, Buffer_Seek seek);
LINKAGE b32 view_set_camera_bounds(Application_Links* app, View_ID view_id, Vec2_f32 margin, Vec2_f32 push_in_multiplier);
LINKAGE b32 view_get_camera_bounds(Application_Links* app, View_ID view_id, Vec2_f32* margin, Vec2_f32* push_in_multiplier);
LINKAGE b32 view_set_cursor(Application_Links* app, View_ID view_id, Buffer_Seek seek);
LINKAGE b32 view_set_buffer_scroll(Application_Links* app, View_ID view_id, Buffer_Scroll scroll, Set_Buffer_Scroll_Rule rule);
LINKAGE b32 view_set_mark(Application_Links* app, View_ID view_id, Buffer_Seek seek);
LINKAGE b32 view_quit_ui(Application_Links* app, View_ID view_id);
LINKAGE b32 view_set_buffer(Application_Links* app, View_ID view_id, Buffer_ID buffer_id, Set_Buffer_Flag flags);
LINKAGE b32 view_push_context(Application_Links* app, View_ID view_id, View_Context* ctx);
LINKAGE b32 view_pop_context(Application_Links* app, View_ID view_id);
LINKAGE b32 view_alter_context(Application_Links* app, View_ID view_id, View_Context* ctx);
LINKAGE View_Context view_current_context(Application_Links* app, View_ID view_id);
LINKAGE String_Const_u8 view_current_context_hook_memory(Application_Links* app, View_ID view_id, Hook_ID hook_id);
LINKAGE Managed_Scope create_user_managed_scope(Application_Links* app);
LINKAGE b32 destroy_user_managed_scope(Application_Links* app, Managed_Scope scope);
LINKAGE Managed_Scope get_global_managed_scope(Application_Links* app);
LINKAGE Managed_Scope get_managed_scope_with_multiple_dependencies(Application_Links* app, Managed_Scope* scopes, i32 count);
LINKAGE b32 managed_scope_clear_contents(Application_Links* app, Managed_Scope scope);
LINKAGE b32 managed_scope_clear_self_all_dependent_scopes(Application_Links* app, Managed_Scope scope);
LINKAGE Base_Allocator* managed_scope_allocator(Application_Links* app, Managed_Scope scope);
LINKAGE u64 managed_id_group_highest_id(Application_Links* app, String_Const_u8 group);
LINKAGE Managed_ID managed_id_declare(Application_Links* app, String_Const_u8 group, String_Const_u8 name);
LINKAGE Managed_ID managed_id_get(Application_Links* app, String_Const_u8 group, String_Const_u8 name);
LINKAGE void* managed_scope_get_attachment(Application_Links* app, Managed_Scope scope, Managed_ID id, u64 size);
LINKAGE b32 managed_scope_attachment_erase(Application_Links* app, Managed_Scope scope, Managed_ID id);
LINKAGE Managed_Object alloc_managed_memory_in_scope(Application_Links* app, Managed_Scope scope, i32 item_size, i32 count);
LINKAGE Managed_Object alloc_buffer_markers_on_buffer(Application_Links* app, Buffer_ID buffer_id, i32 count, Managed_Scope* optional_extra_scope);
LINKAGE u32 managed_object_get_item_size(Application_Links* app, Managed_Object object);
LINKAGE u32 managed_object_get_item_count(Application_Links* app, Managed_Object object);
LINKAGE void* managed_object_get_pointer(Application_Links* app, Managed_Object object);
LINKAGE Managed_Object_Type managed_object_get_type(Application_Links* app, Managed_Object object);
LINKAGE Managed_Scope managed_object_get_containing_scope(Application_Links* app, Managed_Object object);
LINKAGE b32 managed_object_free(Application_Links* app, Managed_Object object);
LINKAGE b32 managed_object_store_data(Application_Links* app, Managed_Object object, u32 first_index, u32 count, void* mem);
LINKAGE b32 managed_object_load_data(Application_Links* app, Managed_Object object, u32 first_index, u32 count, void* mem_out);
LINKAGE User_Input get_next_input_raw(Application_Links* app);
LINKAGE i64 get_current_input_sequence_number(Application_Links* app);
LINKAGE User_Input get_current_input(Application_Links* app);
LINKAGE void set_current_input(Application_Links* app, User_Input* input);
LINKAGE void leave_current_input_unhandled(Application_Links* app);
LINKAGE void set_custom_hook(Application_Links* app, Hook_ID hook_id, Void_Func* func_ptr);
LINKAGE Void_Func* get_custom_hook(Application_Links* app, Hook_ID hook_id);
LINKAGE b32 set_custom_hook_memory_size(Application_Links* app, Hook_ID hook_id, u64 size);
LINKAGE Mouse_State get_mouse_state(Application_Links* app);
LINKAGE b32 get_active_query_bars(Application_Links* app, View_ID view_id, i32 max_result_count, Query_Bar_Ptr_Array* array_out);
LINKAGE b32 start_query_bar(Application_Links* app, Query_Bar* bar, u32 flags);
LINKAGE void end_query_bar(Application_Links* app, Query_Bar* bar, u32 flags);
LINKAGE void clear_all_query_bars(Application_Links* app, View_ID view_id);
LINKAGE void print_message(Application_Links* app, String_Const_u8 message);
LINKAGE b32 log_string(Application_Links* app, String_Const_u8 str);
LINKAGE Face_ID get_largest_face_id(Application_Links* app);
LINKAGE b32 set_global_face(Application_Links* app, Face_ID id);
LINKAGE History_Record_Index buffer_history_get_max_record_index(Application_Links* app, Buffer_ID buffer_id);
LINKAGE Record_Info buffer_history_get_record_info(Application_Links* app, Buffer_ID buffer_id, History_Record_Index index);
LINKAGE Record_Info buffer_history_get_group_sub_record(Application_Links* app, Buffer_ID buffer_id, History_Record_Index index, i32 sub_index);
LINKAGE History_Record_Index buffer_history_get_current_state_index(Application_Links* app, Buffer_ID buffer_id);
LINKAGE b32 buffer_history_set_current_state_index(Application_Links* app, Buffer_ID buffer_id, History_Record_Index index);
LINKAGE b32 buffer_history_merge_record_range(Application_Links* app, Buffer_ID buffer_id, History_Record_Index first_index, History_Record_Index last_index, Record_Merge_Flag flags);
LINKAGE b32 buffer_history_clear_after_current_state(Application_Links* app, Buffer_ID buffer_id);
LINKAGE void global_history_edit_group_begin(Application_Links* app);
LINKAGE void global_history_edit_group_end(Application_Links* app);
LINKAGE b32 buffer_set_face(Application_Links* app, Buffer_ID buffer_id, Face_ID id);
LINKAGE Face_Description get_face_description(Application_Links* app, Face_ID face_id);
LINKAGE Face_Metrics get_face_metrics(Application_Links* app, Face_ID face_id);
LINKAGE Face_Advance_Map get_face_advance_map(Application_Links* app, Face_ID face_id);
LINKAGE Face_ID get_face_id(Application_Links* app, Buffer_ID buffer_id);
LINKAGE Face_ID try_create_new_face(Application_Links* app, Face_Description* description);
LINKAGE b32 try_modify_face(Application_Links* app, Face_ID id, Face_Description* description);
LINKAGE b32 try_release_face(Application_Links* app, Face_ID id, Face_ID replacement_id);
LINKAGE String_Const_u8 push_hot_directory(Application_Links* app, Arena* arena);
LINKAGE void set_hot_directory(Application_Links* app, String_Const_u8 string);
LINKAGE void send_exit_signal(Application_Links* app);
LINKAGE void hard_exit(Application_Links* app);
LINKAGE void set_window_title(Application_Links* app, String_Const_u8 title);
LINKAGE void acquire_global_frame_mutex(Application_Links* app);
LINKAGE void release_global_frame_mutex(Application_Links* app);
LINKAGE Vec2_f32 draw_string_oriented(Application_Links* app, Face_ID font_id, ARGB_Color color, String_Const_u8 str, Vec2_f32 point, u32 flags, Vec2_f32 delta);
LINKAGE f32 get_string_advance(Application_Links* app, Face_ID font_id, String_Const_u8 str);
//LINKAGE void draw_rect(Application_Links* app, Rect_f32 rect, f32 roundness, ARGB_Color color);
LINKAGE void draw_rect_outline(draw_rect_outline_params);
LINKAGE Rect_f32 draw_set_clip(Application_Links* app, Rect_f32 new_clip);
LINKAGE Text_Layout_ID text_layout_create(Application_Links* app, Buffer_ID buffer_id, Rect_f32 rect, Buffer_Point buffer_point);
LINKAGE Rect_f32 text_layout_region(Application_Links* app, Text_Layout_ID text_layout_id);
LINKAGE Buffer_ID text_layout_get_buffer(Application_Links* app, Text_Layout_ID text_layout_id);
LINKAGE Range_i64 text_layout_get_visible_range(Application_Links* app, Text_Layout_ID text_layout_id);
LINKAGE Range_f32 text_layout_line_on_screen(Application_Links* app, Text_Layout_ID layout_id, i64 line_number);
LINKAGE Rect_f32 text_layout_character_on_screen(Application_Links* app, Text_Layout_ID layout_id, i64 pos);
LINKAGE void paint_text_color(Application_Links* app, Text_Layout_ID layout_id, Range_i64 range, ARGB_Color color);
LINKAGE void paint_text_color_blend(Application_Links* app, Text_Layout_ID layout_id, Range_i64 range, ARGB_Color color, f32 blend);
LINKAGE b32 text_layout_free(Application_Links* app, Text_Layout_ID text_layout_id);
