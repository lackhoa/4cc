...
//source: UNKNOWN
api(ed) function Arena_Chunk* get_arena_chunk(usize size);
api(ed) function void free_arena_chunk(Arena_Chunk* chunk);
...
api(ed) function void DEBUG_register_arena_chunk(Arena_Chunk* chunk, File_Line file_line);
api(ed) function void DEBUG_free_arena_chunk(Arena_Chunk* chunk);
api(ed) function void DEBUG_arena_chunk_push(Arena_Chunk* chunk, usize pos_in_chunk, usize size, File_Line file_line);
api(ed) function void DEBUG_arena_chunk_truncate(Arena_Chunk* chunk);
