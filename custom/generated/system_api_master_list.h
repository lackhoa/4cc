...
api(system) function File_Attributes quick_file_attributes(Arena* scratch, String file_name);
...
api(system) function File_Attributes save_file(Arena* scratch, char* file_name, String data);
api(system) function b32 load_library(Arena* scratch, String file_name, System_Library* out);
...
api(system) function void* memory_allocate(u64 size, String location);
