...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("global_get_screen_rectangle"), string_u8_litexpr("rect2"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
}
{
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("get_buffer_by_filename"), string_u8_litexpr("Buffer_ID"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_buffer_base_name"), string_u8_litexpr("String8"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_buffer_filename"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "arena");
api_param(arena, call, "Buffer_ID", "buffer_id");
}
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_hot_directory"), string_u8_litexpr("String8"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "arena");
}
{
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("draw_string_oriented"), string_u8_litexpr("v2"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
