...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("get_buffer_count"), string_u8_litexpr("i1"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
}
{
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_buffer_base_name"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "arena");
api_param(arena, call, "Buffer_ID", "buffer_id");
}
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_buffer_unique_name"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "out");
api_param(arena, call, "Buffer_ID", "buffer_id");
}
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_buffer_file_name"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "arena");
api_param(arena, call, "Buffer_ID", "buffer_id");
}
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("view_current_context_hook_memory"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "View_ID", "view_id");
...
api_param(arena, call, "App*", "app");
api_param(arena, call, "Managed_Scope", "scope");
api_param(arena, call, "i1", "item_size");
api_param(arena, call, "i1", "count");
}
{
...
api_param(arena, call, "App*", "app");
api_param(arena, call, "View_ID", "view_id");
api_param(arena, call, "i1", "max_result_count");
...
api_param(arena, call, "App*", "app");
api_param(arena, call, "String", "message");
}
{
...
api_param(arena, call, "Buffer_ID", "buffer_id");
api_param(arena, call, "History_Record_Index", "index");
api_param(arena, call, "i1", "sub_index");
}
{
...
{
API_Call *call = api_call_with_location(arena, result, string_u8_litexpr("push_hot_directory"), string_u8_litexpr("String"), string_u8_litexpr(""));
api_param(arena, call, "App*", "app");
api_param(arena, call, "Arena*", "arena");
}
{
...
api_param(arena, call, "App*", "app");
api_param(arena, call, "String", "title");
}
{
...
api_param(arena, call, "Arena*", "arena");
api_param(arena, call, "Buffer_ID", "buffer");
api_param(arena, call, "i1", "string_id");
api_param(arena, call, "Range_i64", "range");
api_param(arena, call, "String", "needle");
api_param(arena, call, "Character_Predicate*", "predicate");
api_param(arena, call, "Scan_Direction", "direction");
