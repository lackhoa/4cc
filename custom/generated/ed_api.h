...
//source: UNKNOWN
#define ed_get_arena_chunk_sig() Arena_Chunk* ed_get_arena_chunk(usize size)
#define ed_free_arena_chunk_sig() void ed_free_arena_chunk(Arena_Chunk* chunk)
...
#define ed_DEBUG_register_arena_chunk_sig() void ed_DEBUG_register_arena_chunk(Arena_Chunk* chunk, File_Line file_line)
#define ed_DEBUG_free_arena_chunk_sig() void ed_DEBUG_free_arena_chunk(Arena_Chunk* chunk)
#define ed_DEBUG_arena_chunk_push_sig() void ed_DEBUG_arena_chunk_push(Arena_Chunk* chunk, usize pos_in_chunk, usize size, File_Line file_line)
#define ed_DEBUG_arena_chunk_truncate_sig() void ed_DEBUG_arena_chunk_truncate(Arena_Chunk* chunk)
typedef Arena_Chunk* ed_get_arena_chunk_type(usize size);
typedef void ed_free_arena_chunk_type(Arena_Chunk* chunk);
...
typedef void ed_DEBUG_register_arena_chunk_type(Arena_Chunk* chunk, File_Line file_line);
typedef void ed_DEBUG_free_arena_chunk_type(Arena_Chunk* chunk);
typedef void ed_DEBUG_arena_chunk_push_type(Arena_Chunk* chunk, usize pos_in_chunk, usize size, File_Line file_line);
typedef void ed_DEBUG_arena_chunk_truncate_type(Arena_Chunk* chunk);
struct API_VTable_ed{
ed_get_arena_chunk_type *get_arena_chunk;
ed_free_arena_chunk_type *free_arena_chunk;
...
ed_DEBUG_register_arena_chunk_type *DEBUG_register_arena_chunk;
ed_DEBUG_free_arena_chunk_type *DEBUG_free_arena_chunk;
ed_DEBUG_arena_chunk_push_type *DEBUG_arena_chunk_push;
ed_DEBUG_arena_chunk_truncate_type *DEBUG_arena_chunk_truncate;
};
#if defined(STATIC_LINK_API)
function Arena_Chunk* get_arena_chunk(usize size);
...
function void DEBUG_register_arena_chunk(Arena_Chunk* chunk, File_Line file_line);
function void DEBUG_free_arena_chunk(Arena_Chunk* chunk);
function void DEBUG_arena_chunk_push(Arena_Chunk* chunk, usize pos_in_chunk, usize size, File_Line file_line);
function void DEBUG_arena_chunk_truncate(Arena_Chunk* chunk);
#undef STATIC_LINK_API
#elif defined(DYNAMIC_LINK_API)
#ifndef STORAGE_CLASS
#define STORAGE_CLASS global
#endif
STORAGE_CLASS ed_get_arena_chunk_type *get_arena_chunk;
STORAGE_CLASS ed_free_arena_chunk_type *free_arena_chunk;
...
STORAGE_CLASS ed_DEBUG_register_arena_chunk_type *DEBUG_register_arena_chunk;
STORAGE_CLASS ed_DEBUG_free_arena_chunk_type *DEBUG_free_arena_chunk;
STORAGE_CLASS ed_DEBUG_arena_chunk_push_type *DEBUG_arena_chunk_push;
STORAGE_CLASS ed_DEBUG_arena_chunk_truncate_type *DEBUG_arena_chunk_truncate;
