...
normal_commands{
 F4_Index_Reset "Reset the index"
  ...
  redo_all_buffers "Advances forward through the undo history in the buffer containing the most recent regular edit."
  undo_all_buffers "Advances backward through the undo history in the buffer containing the most recent regular edit."
